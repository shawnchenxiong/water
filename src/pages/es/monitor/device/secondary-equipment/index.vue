<template>
  <DeviceMonitorLayout>
    ...
    <template #left>
      <StationTree
        device-type="secondary-equipment"
    ...
    <!-- 右侧内容区 -->
    <template #right>
      <div class="secondary-equipment-content">
        <!-- 统计栏和工具栏在同一行 -->
        ...
        <div class="content-area">
          <el-table
            :data="tableData"
            class="secondary-equipment-table"
            style="width: 100%"
          >
...
const handlePageChange = () => {
  ElMessage.info(`切换到第${currentPage.value}页`)
}
