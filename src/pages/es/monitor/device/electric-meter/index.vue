        ...
        <div class="top-bar" :class="{ 'mobile': isMobile }">
          ...
          <div class="toolbar-section">
            ...
            <el-select
              ...
              :size="isMobile ? 'small' : 'default'"
              @change="handleMeterLineChange"
            >
              <el-option label="全部" value="all" />
              <el-option label="查询线1" value="line1" />
              <el-option label="查询线2" value="line2" />
            </el-select>
            <el-button 
              type="primary"
              :size="isMobile ? 'small' : 'default'"
...
const meterLine = ref<string>('all') // 查询线
...
// 查询线变化
const handleMeterLineChange = () => {
  ElMessage.info(`切换查询线: ${meterLine.value}`)
}
