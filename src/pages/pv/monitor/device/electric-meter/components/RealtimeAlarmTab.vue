  ...
  <div class="realtime-alarm-tab">
    ...
    <div class="table-wrapper">
      ...
      >
        ...
        <el-table-column label="确认状态" prop="confirmStatus" width="100">
          <template #default="{ row }">
        ...
        <el-table-column label="操作" width="120" fixed="right">
          <template #default="{ row }">
            <el-button type="primary" :size="isMobile ? 'small' : 'small'" link @click="handleConfirm(row)">
              确认
            </el-button>
            <el-button type="danger" :size="isMobile ? 'small' : 'small'" link @click="handleClear(row)">
              消除
            </el-button>
          </template>
        </el-table-column>
...
import { getRealtimeAlarms, confirmAlarms, clearAlarms } from '@/api/device/electricMeterDetail';
