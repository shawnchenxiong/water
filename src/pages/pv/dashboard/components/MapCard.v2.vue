<template>
  <div class="map-card">
    ...
    <div class="map-controls-left">
      <div class="control-btn" title="切换视图" @click="toggleView">
        <el-icon><View /></el-icon>
      </div>
      <div class="control-btn" title="设置" @click="handleSettings">
        <el-icon><Setting /></el-icon>
      </div>
      <div class="control-btn station-detail-btn" title="电站详情" @click="showStationDetail">
...
import { Grid, View, Setting, Location } from '@element-plus/icons-vue'
import { ElMessage } from 'element-plus'
import { getCityStations } from '@/api/pvDashboardApi'
...
const drawProvinceAndCities = async (provinceData: any, provinceAdcode: number) => {
  ...
  try {
    ...
    geojson.features.forEach((feature: any) => {
      ...
      const cityFillColor = cityHasStation ? '#0074da' : '#3fa4ff'
...
const addChinaDistrictLayer = async () => {
  ...
  try {
    ...
    geojson.features.forEach((feature: any) => {
      ...
      const fillColor = hasData ? '#0074da' : '#3fa4ff'
