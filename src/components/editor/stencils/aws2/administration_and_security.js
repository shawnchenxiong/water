export default `<shapes name="mxgraph.aws2.administration_and_security">
<shape aspect="variable" h="72" name="Config" strokewidth="inherit" w="59.6">
    <connections>
...
<shape aspect="variable" h="72" name="Trusted Advisor" strokewidth="inherit" w="59.6">
    <connections>
        <constraint name="N" perimeter="0" x="0.5" y="0"/>
        <constraint name="S" perimeter="0" x="0.5" y="1"/>
        <constraint name="W" perimeter="0" x="0" y="0.5"/>
        ...
        <constraint name="SW" perimeter="0" x="0.18" y="0.87"/>
