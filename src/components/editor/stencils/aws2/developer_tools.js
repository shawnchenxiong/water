export default `<shapes name="mxgraph.aws2.developer_tools">
<shape aspect="variable" h="82.3" name="Code Commit" strokewidth="inherit" w="68.2">
    <connections>
...
<shape aspect="variable" h="72" name="Code Pipeline" strokewidth="inherit" w="59.6">
    <connections>
        <constraint name="N" perimeter="0" x="0.5" y="0"/>
        <constraint name="S" perimeter="0" x="0.5" y="1"/>
        <constraint name="W" perimeter="0" x="0" y="0.5"/>
