export default `<shapes name="mxGraph.flowchart">
    <shape w="1024" h="810.709" name="light rain" strokewidth="inherit" aspect="variable">
        <connections>
            <constraint x="0.5" y="0.05" perimeter="0" name="N"/>
            <constraint x="0.05" y="0.68" perimeter="0" name="W"/>
            <constraint x="0.95" y="0.68" perimeter="0" name="E"/>
        </connections>
        <background>
            <path>
                <move x="640" y="128"/>
                <line x="640.028" y="332.943"/>
                <arc large-arc-flag="0" rx="257.252" ry="257.252" sweep-flag="1" x="733.724" x-axis-rotation="0" y="426.639"/>
                <line x="896" y="426.667"/>
                <line x="896" y="682.667"/>
                <line x="733.753" y="682.667"/>
                <arc large-arc-flag="0" rx="255.886" ry="255.886" sweep-flag="1" x="512" x-axis-rotation="0" y="810.667"/>
                <arc large-arc-flag="0" rx="255.886" ry="255.886" sweep-flag="1" x="290.247" x-axis-rotation="0" y="682.667"/>
                <line x="128" y="682.667"/>
                <line x="128" y="426.667"/>
                <line x="290.276" y="426.639"/>
                <arc large-arc-flag="0" rx="257.252" ry="257.252" sweep-flag="1" x="384" x-axis-rotation="0" y="332.914"/>
                <line x="384" y="128"/>
                <line x="640" y="128"/>
                <close/>
                <move x="42.667" y="341.334"/>
                <arc large-arc-flag="0" rx="42.667" ry="42.667" sweep-flag="1" x="85.333" x-axis-rotation="0" y="384"/>
                <line x="85.333" y="725.334"/>
                <arc large-arc-flag="0" rx="42.667" ry="42.667" sweep-flag="1" x="0" x-axis-rotation="0" y="725.334"/>
                <line x="0" y="384"/>
                <arc large-arc-flag="0" rx="42.667" ry="42.667" sweep-flag="1" x="42.667" x-axis-rotation="0" y="341.334"/>
                <close/>
                <move x="981.333" y="341.334"/>
                <arc large-arc-flag="0" rx="42.667" ry="42.667" sweep-flag="1" x="1024" x-axis-rotation="0" y="384"/>
                <line x="1024" y="725.334"/>
                <arc large-arc-flag="0" rx="42.667" ry="42.667" sweep-flag="1" x="938.667" x-axis-rotation="0" y="725.334"/>
                <line x="938.667" y="384"/>
                <arc large-arc-flag="0" rx="42.667" ry="42.667" sweep-flag="1" x="981.333" x-axis-rotation="0" y="341.334"/>
                <close/>
                <move x="512" y="440.889"/>
                <arc large-arc-flag="1" rx="113.778" ry="113.778" sweep-flag="0" x="512" x-axis-rotation="0" y="668.445"/>
                <arc large-arc-flag="0" rx="113.778" ry="113.778" sweep-flag="0" x="512" x-axis-rotation="0" y="440.889"/>
                <close/>
                <move x="682.667" y="0"/>
                <arc large-arc-flag="0" rx="42.667" ry="42.667" sweep-flag="1" x="682.667" x-axis-rotation="0" y="85.334"/>
                <line x="341.333" y="85.334"/>
                <arc large-arc-flag="0" rx="42.667" ry="42.667" sweep-flag="1" x="341.333" x-axis-rotation="0" y="0"/>
                <line x="682.667" y="0"/>
                <close/>
            </path>
        </background>
