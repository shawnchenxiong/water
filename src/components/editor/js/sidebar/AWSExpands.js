...
(function(){
	...
	Sidebar.prototype.addAWS3AnalyticsPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Analytics', 'Analytics', false,
		[
	...
	Sidebar.prototype.addAWS3ApplicationServicesPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Application Services', 'Application Services', false,
		[
	...
	Sidebar.prototype.addAWS3ArtificialIntelligencePalette = function()
	{
		...
		this.addPaletteFunctions('aws3Artificial Intelligence', 'Artificial Intelligence', false,
		[
	...
	Sidebar.prototype.addAWS3BusinessProductivityPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Business Productivity', 'Business Productivity', false,
		[
	...
	Sidebar.prototype.addAWS3ComputePalette = function()
	{
		...
		this.addPaletteFunctions('aws3Compute', 'Compute', false,
		[
	...
	Sidebar.prototype.addAWS3ContactCenterPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Contact Center', 'Contact Center', false,
		[
	...
	Sidebar.prototype.addAWS3DatabasePalette = function()
	{
		...
		this.addPaletteFunctions('aws3Database', 'Database', false,
		[
	...
	Sidebar.prototype.addAWS3DesktopAndAppStreamingPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Desktop and App Streaming', 'Desktop and App Streaming', false,
		[
	...
	Sidebar.prototype.addAWS3DeveloperToolsPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Developer Tools', 'Developer Tools', false,
		[
	...
	Sidebar.prototype.addAWS3GameDevelopmentPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Game Development', 'Game Development', false,
		[
	...
	Sidebar.prototype.addAWS3GeneralPalette = function()
	{
		...
		this.addPaletteFunctions('aws3General', 'General', false,
		[
	...
	Sidebar.prototype.addAWS3GroupsPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Groups', 'Groups', false,
		[
	...
	Sidebar.prototype.addAWS3InternetOfThingsPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Internet of Things', 'Internet of Things', false,
		[
	...
	Sidebar.prototype.addAWS3ManagementToolsPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Management Tools', 'Management Tools', false,
		[
	...
	Sidebar.prototype.addAWS3MessagingPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Messaging', 'Messaging', false,
		[
	...
	Sidebar.prototype.addAWS3MigrationPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Migration', 'Migration', false,
		[
	...
	Sidebar.prototype.addAWS3MobileServicesPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Mobile Services', 'Mobile Services', false,
		[
			 this.createVertexTemplateEntry(n + 'api_gateway;fillColor=#D9A741;gradientColor=none;',
					 s * 51, s * 62, '', 'API Gateway', null, null, this.getTagsForStencil(gn, 'api gateway', dt).join(' ')),
	...
	Sidebar.prototype.addAWS3NetworkAndContentDeliveryPalette = function()
	{
		...
		this.addPaletteFunctions('aws3Networking and Content Delivery', 'Network and Content Delivery', false,
		[
	...
	Sidebar.prototype.addAWS3OnDemandWorkforcePalette = function()
	{
		...
		this.addPaletteFunctions('aws3On Demand Workforce', 'On-Demand Workforce', false,
		[
	...
	Sidebar.prototype.addAWS3SDKPalette = function()
	{
		...
		this.addPaletteFunctions('aws3SDKs', 'SDK', false,
		[
	...
	Sidebar.prototype.addAWS3SecurityIdentityAndCompliancePalette = function()
	{
		...
		this.addPaletteFunctions('aws3Security Identity and Compliance', 'Security Identity and Compliance', false,
		[
	...
	Sidebar.prototype.addAWS3StoragePalette = function()
	{
		...
		this.addPaletteFunctions('aws3Storage', 'Storage', false,
		[
