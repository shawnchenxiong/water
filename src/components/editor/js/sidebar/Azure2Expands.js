...
(function()
{
	...
	Sidebar.prototype.addAzure2Palette = function()
	{
		...
		var r = 400;
		var sb = this;
		var s = 'image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=' + mxUtils.staticImg('/rcscada/img/azure2/');
	...
	Sidebar.prototype.addAzure2AIMachineLearningPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2AI Machine Learning', '微软/人工智能和机器学习', false, mxUtils.bind(this, function(content)
				{
	...
	Sidebar.prototype.addAzure2AnalyticsPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Analytics', '微软/数据分析', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2AppServicesPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2App Services', '微软/应用程序服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2EcosystemPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Azure Ecosystem', '微软/生态系统', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2AzureStackPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Azure Stack', '微软/堆栈', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2AzureVMwareSolutionPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Azure VMware Solution', '微软/虚拟机解决方案', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2BlockchainPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Blockchain', '微软/区块链', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2ComputePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Compute', '微软/计算机', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2ContainersPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Containers', '微软/容器', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2CXPPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2CXP', '微软/客户体验', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2DatabasesPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Databases', '微软/数据库', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2DevOpsPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2DevOps', '微软/运维', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2GeneralPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2General', '微软/一般服务与功能', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2IdentityPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Identity', '微软/身份验证', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2IntegrationPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Integration', '微软/程序集成和通信', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2InternetOfThingsPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Internet of Things', '微软/服务和工具', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2IntunePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Intune', '微软/设备和应用管理', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2IOTPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2IoT', '微软/物联网解决方案', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2ManagementGovernancePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Management Governance', '微软/管理与治理', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2MenuPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Menu', '微软/菜单服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2MigratePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Migrate', '微软/迁移服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2MixedRealityPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Mixed Reality', '微软/混合现实解决方案', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2MonitorPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Monitor', '微软/监控服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2NetworkingPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Networking', '微软/网络服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2OtherPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Other', '微软/其他云服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2PreviewPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Preview', '微软/预览功能', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2SecurityPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Security', '微软/安全解决方案', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2StoragePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Storage', '微软/存储服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAzure2WebPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('azure2Web', '微软/网页服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
