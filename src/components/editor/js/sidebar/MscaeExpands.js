...
(function()
{
	...
	Sidebar.prototype.addMSCAEPalette = function()
	{
		...
		var r = 100;
		var sb = this;
		var s = 'image;sketch=0;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=' + mxUtils.staticImg('/rcscada/img/mscae/');
	...
	Sidebar.prototype.addMSCAECompaniesPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeCompanies', '工程软件', false, mxUtils.bind(this, function(content)
				{
	...
	Sidebar.prototype.addMSCAEEnterpriseFlatPalette = function(gn, r, sb)
	{
		...
		this.addPalette('mscaeEnterpriseFlat', '工程软件解决方案', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEIntuneFlatPalette = function(gn, r, sb)
	{
		...
		this.addPalette('mscaeIntuneFlat', 'CAE/终结点管理', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEOMSFlatPalette = function(gn, r, sb)
	{
		...
		this.addPalette('mscaeOMSFlat', 'CAE/订单管理', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAESystemCenterFlatPalette = function(gn, r, sb)
	{
		...
		this.addPalette('mscaeSystem CenterFlat', 'CAE/系统中心', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEAIandMLServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeAI and ML Service', 'CAE/人工智能与机器学习', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEAnalyticsServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeAnalytics Service', 'CAE/分析服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEComputeServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeCompute Service', 'CAE/计算服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEComputeServiceVMPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeCompute Service VM', 'CAE/虚拟计算服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEContainerServiceVMPalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeContainer Service', 'CAE/容器服务', false, mxUtils.bind(this, function(content)
		{
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEDatabasesServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeDatabases Service', 'CAE/数据库服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEDevOpsServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeDevOps Service', 'CAE/运维服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEGeneralServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeGeneral Service', 'CAE/常规服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEIdentityServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeIdentity Service', 'CAE/身份服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEIntegrationServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeIntegration Service', 'CAE/集成服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEInternetOfThingsServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeInternet of Things Service', 'CAE/物联网服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEIntuneServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeIntune Service', 'CAE/企业移动设备', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEManagementGovernanceServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeManagement and Governance Service', 'CAE/管理与治理服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEManagementGovernanceMediaServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeManagement and Governance Service Media', 'CAE/媒体管理与治理服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEMigrateServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeMigrate Service', 'CAE/迁移服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEMixedRealityServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeMixed Reality Service', 'CAE/混合现实解决方案', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEMobileServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeMobile Service', 'CAE/移动服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAENetworkingServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeNetworking Service', 'CAE/网络服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEOtherCategoryServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeOther Category Service', 'CAE/其他类别的服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAESecurityServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeSecurity Service', 'CAE/安全服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEStorageServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeStorage Service', 'CAE/存储服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addMSCAEWebServicePalette = function(gn, r, sb, s)
	{
		...
		this.addPalette('mscaeWeb Service', 'CAE/网页服务', false, mxUtils.bind(this, function(content)
				{
					for (var i = 0; i < fns.length; i++)
					{
						content.appendChild(fns[i](content));
