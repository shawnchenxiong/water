...
(function () {
  ...
  Sidebar.prototype.addUml25Palette = function (expand) {
    const sb = this;
    ...
    divider.vertex = true;
    const sequenceEdgeStyle = 'newEdgeStyle={"curved":0,"rounded":0};';
    const lifelineStyle = 'shape=umlLifeline;perimeter=lifelinePerimeter;whiteSpace=wrap;html=1;container=1;dropTarget=0;' +
      'collapsible=0;recursiveResize=0;outlineConnect=0;portConstraint=eastwest;' + sequenceEdgeStyle;
    const frameStyle = 'shape=umlFrame;whiteSpace=wrap;html=1;pointerEvents=0;recursiveResize=0;container=1;collapsible=0;';
    const dt = 'uml ';
    const fns = [
    ...
    this.addPalette('uml25', mxResources.get('uml') + ' 2.5', null == expand || expand, mxUtils.bind(this, function (content) {
