...
(function () {
  ...
  Sidebar.prototype.addFlowchartPalette = function (expand) {
    const w = 100;
    const h = 100;
    const s = 'strokeWidth=2;html=1;shape=mxgraph.flowchart.';
    const s2 = mxConstants.STYLE_VERTICAL_LABEL_POSITION + '=bottom;' + mxConstants.STYLE_VERTICAL_ALIGN + '=top;html=1;shape=mxgraph.flowchart.';
    const s3 = mxConstants.STYLE_VERTICAL_LABEL_POSITION + '=bottom;' + mxConstants.STYLE_VERTICAL_ALIGN + '=top;html=1;shape=';
    const gn = 'mxgraph.flowchart';
    const dt = '';
    this.addPaletteFunctions('flowchart', mxResources.get('flowchart'), null == expand || expand, [
      this.createVertexTemplateEntry(s + 'light_rain;align=left;pointerEvents=1;', w, h, '', 'Light Rain', null, null, null),
