...
(function () {
  ...
  Sidebar.prototype.addErPalette = function (expand) {
    // Avoids having to bind all functions to "this"
    const sb = this;
    // Reusable cells
    const row = new mxCell('Item', new mxGeometry(0, 0, 40, 30), 'text;strokeColor=none;fillColor=none;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;fontSize=12;whiteSpace=wrap;html=1;');
    row.vertex = true;
    // Predefined dimensions
    const w = 100;
    const h = 100;
    // Default tags
    const dt = 'db database schema er entity relation table ';
    ...
    this.addPaletteFunctions('er', mxResources.get('entityRelation'), null == expand || expand, fns);
  };
