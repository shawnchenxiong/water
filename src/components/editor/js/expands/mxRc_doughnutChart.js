...
export default mxRc_doughnutChart;

function mxRc_doughnutChart(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_doughnutChart, mxShape);
mxRc_doughnutChart.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_doughnutChart',
};
mxRc_doughnutChart.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_doughnutChart.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_doughnutChart.prototype.getChartConfigOption = function () {
...
mxRc_doughnutChart.prototype.renderChart = function (divId, option) {
