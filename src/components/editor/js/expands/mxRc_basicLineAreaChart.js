...
export default mxRc_basicLineAreaChart;

function mxRc_basicLineAreaChart(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_basicLineAreaChart, mxShape);
mxRc_basicLineAreaChart.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_basicLineAreaChart',
};
mxRc_basicLineAreaChart.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_basicLineAreaChart.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_basicLineAreaChart.prototype.getChartConfigOption = function () {
...
mxRc_basicLineAreaChart.prototype.renderChart = function (divId, option) {
