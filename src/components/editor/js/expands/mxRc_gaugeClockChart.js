...
export default mxRc_gaugeClockChart;

function mxRc_gaugeClockChart(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_gaugeClockChart, mxShape);
mxRc_gaugeClockChart.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_gaugeClockChart',
};
mxRc_gaugeClockChart.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_gaugeClockChart.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_gaugeClockChart.prototype.getChartConfigOption = function () {
    let  option = {};
    const graph = this.state.view.graph;
...
mxRc_gaugeClockChart.prototype.renderChart = function (divId, option) {
