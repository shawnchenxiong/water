...
export default mxRc_multiSymbolChart;

function mxRc_multiSymbolChart(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_multiSymbolChart, mxShape);
mxRc_multiSymbolChart.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_multiSymbolChart',
};
mxRc_multiSymbolChart.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_multiSymbolChart.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_multiSymbolChart.prototype.getChartConfigOption = function () {
    let  option = {};
    const graph = this.state.view.graph;
...
mxRc_multiSymbolChart.prototype.renderChart = function (divId, option) {
