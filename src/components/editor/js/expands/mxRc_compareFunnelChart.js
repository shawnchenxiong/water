...
export default mxRc_compareFunnelChart;

function mxRc_compareFunnelChart(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_compareFunnelChart, mxShape);
mxRc_compareFunnelChart.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_compareFunnelChart',
};
mxRc_compareFunnelChart.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_compareFunnelChart.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_compareFunnelChart.prototype.getChartConfigOption = function () {
    let  option = {};
    const graph = this.state.view.graph;
...
mxRc_compareFunnelChart.prototype.renderChart = function (divId, option) {
