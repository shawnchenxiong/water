...
export default mxRc_basicGauge;

function mxRc_basicGauge(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_basicGauge, mxShape);
mxRc_basicGauge.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_basicGauge',
};
mxRc_basicGauge.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_basicGauge.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_basicGauge.prototype.renderChart = function (divId) {
    /* ----------------------------配置参数------------------------  */
