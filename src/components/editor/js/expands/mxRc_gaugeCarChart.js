...
export default mxRc_gaugeCarChart;

function mxRc_gaugeCarChart(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_gaugeCarChart, mxShape);
mxRc_gaugeCarChart.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_gaugeCarChart',
};
mxRc_gaugeCarChart.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_gaugeCarChart.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_gaugeCarChart.prototype.getChartConfigOption = function () {
    let  option = {};
    const graph = this.state.view.graph;
...
mxRc_gaugeCarChart.prototype.renderChart = function (divId, option) {
