...
export default mxRc_basicBoxplot;

function mxRc_basicBoxplot(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_basicBoxplot, mxShape);
mxRc_basicBoxplot.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_basicBoxplot',
};
mxRc_basicBoxplot.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_basicBoxplot.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_basicBoxplot.prototype.renderChart = function (divId, data) {
