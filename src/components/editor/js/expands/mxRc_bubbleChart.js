...
export default mxRc_bubbleChart;

function mxRc_bubbleChart(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_bubbleChart, mxShape);
mxRc_bubbleChart.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_bubbleChart',
};
mxRc_bubbleChart.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_bubbleChart.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_bubbleChart.prototype.getChartConfigOption = function () {
    let  option = {};
    const graph = this.state.view.graph;
...
mxRc_bubbleChart.prototype.renderChart = function (divId, option) {
