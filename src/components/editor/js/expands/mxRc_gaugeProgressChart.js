...
export default mxRc_gaugeProgressChart;

function mxRc_gaugeProgressChart(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_gaugeProgressChart, mxShape);
mxRc_gaugeProgressChart.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_gaugeProgressChart',
};
mxRc_gaugeProgressChart.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_gaugeProgressChart.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_gaugeProgressChart.prototype.getChartConfigOption = function () {
    let  option = {};
    const graph = this.state.view.graph;
...
mxRc_gaugeProgressChart.prototype.renderChart = function (divId, option) {
