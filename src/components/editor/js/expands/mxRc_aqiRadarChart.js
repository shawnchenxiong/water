...
export default mxRc_aqiRadarChart;

function mxRc_aqiRadarChart(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_aqiRadarChart, mxShape);
mxRc_aqiRadarChart.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_aqiRadarChart',
};
mxRc_aqiRadarChart.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_aqiRadarChart.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_aqiRadarChart.prototype.getChartConfigOption = function () {
    let  option = {};
    const graph = this.state.view.graph;
...
mxRc_aqiRadarChart.prototype.renderChart = function (divId, option) {
