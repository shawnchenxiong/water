...
import * as ecSimpleTransform from "../utils/ecSimpleTransform.min.js";

export default mxRc_simpleBoxplotChart;

function mxRc_simpleBoxplotChart(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_simpleBoxplotChart, mxShape);
mxRc_simpleBoxplotChart.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_simpleBoxplotChart',
};
mxRc_simpleBoxplotChart.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_simpleBoxplotChart.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_simpleBoxplotChart.prototype.getChartConfigOption = function () {
...
mxRc_simpleBoxplotChart.prototype.renderChart = function (divId, option) {
