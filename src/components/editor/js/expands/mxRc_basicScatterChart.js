...
export default mxRc_basicScatterChart;

function mxRc_basicScatterChart(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_basicScatterChart, mxShape);
mxRc_basicScatterChart.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_basicScatterChart',
};
mxRc_basicScatterChart.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_basicScatterChart.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_basicScatterChart.prototype.renderChart = function (divId, data) {
