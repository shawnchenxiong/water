...
export default mxRc_graphChord;

function mxRc_graphChord(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_graphChord, mxShape);
mxRc_graphChord.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_graphChord',
};
mxRc_graphChord.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_graphChord.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_graphChord.prototype.renderChart = function (divId, data) {
    /* ----------------------------配置参数------------------------  */
