...
export default mxRc_gaugeTemperatureChart;

function mxRc_gaugeTemperatureChart(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_gaugeTemperatureChart, mxShape);
mxRc_gaugeTemperatureChart.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_gaugeTemperatureChart',
};
mxRc_gaugeTemperatureChart.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_gaugeTemperatureChart.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_gaugeTemperatureChart.prototype.getChartConfigOption = function () {
    let  option = {};
    const graph = this.state.view.graph;
...
mxRc_gaugeTemperatureChart.prototype.renderChart = function (divId, option) {
