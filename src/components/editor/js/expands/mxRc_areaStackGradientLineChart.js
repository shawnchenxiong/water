...
export default mxRc_areaStackGradientLineChart;

function mxRc_areaStackGradientLineChart(bounds, fill, stroke, strokewidth) {
    mxShape.call(this);
    this.bounds = bounds;
    this.fill = fill;
    this.stroke = stroke;
...
mxUtils.extend(mxRc_areaStackGradientLineChart, mxShape);
mxRc_areaStackGradientLineChart.prototype.cst = {
    SHAPE_NAME: 'mxgraph.rc.mxRc_areaStackGradientLineChart',
};
mxRc_areaStackGradientLineChart.prototype.paintVertexShape = function (c, x, y, w, h) {
    this.foreground(c, x, y, w, h);
};
mxRc_areaStackGradientLineChart.prototype.foreground = function (c, x, y, w, h) {
    if (this.antiAlias) {
...
mxRc_areaStackGradientLineChart.prototype.getChartConfigOption = function () {
...
mxRc_areaStackGradientLineChart.prototype.renderChart = function (divId, option) {
