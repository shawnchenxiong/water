...
"xgplayer.min.js"(exports, module) {
...
(function (e, t) {
	...
	function s(e, t, i) {
		return (t = y(t)) in e ? Object.defineProperty(e, t, { value: i, enumerable: !0, configurable: !0, writable: !0 }) : (e[t] = i), e;
	}
	function a(e, t) {
		...
		Object.create && ((n.prototype = Object.create(null)), new n().__proto__ || (i = !1)),
			...
			(a.prototype.removeListener = function (e, t, n, o) {
				...
				if (a.fn) a.fn !== t || (o && !a.once) || (n && a.context !== n) || s(this, r);
					...
					for (var l = 0, c = [], u = a.length; l < u; l++) (a[l].fn !== t || (o && !a[l].once) || (n && a[l].context !== n)) && c.push(a[l]);
			...
			(a.prototype.removeAllListeners = function (e) {
				var t;
				return e ? ((t = i ? i + e : e), this._events[t] && s(this, t)) : ((this._events = new n()), (this._eventsCount = 0)), this;
			}),
	...
	var k = m.exports,
		C = 'undefined' != typeof window && window.location && window.location.href.indexOf('xgplayerdebugger=1') > -1,
		b = { info: 'color: #525252; background-color: #90ee90;', error: 'color: #525252; background-color: red;', warn: 'color: #525252; background-color: yellow; ' },
		_ = '%c[xgplayer]',
		w = {
			config: { debug: C ? 3 : 0 },
			logInfo: function (e) {
				for (var t, i = arguments.length, n = new Array(i > 1 ? i - 1 : 0), o = 1; o < i; o++) n[o - 1] = arguments[o];
				this.config.debug >= 3 && (t = console).log.apply(t, [_, b.info, e].concat(n));
			},
			logWarn: function (e) {
				for (var t, i = arguments.length, n = new Array(i > 1 ? i - 1 : 0), o = 1; o < i; o++) n[o - 1] = arguments[o];
				this.config.debug >= 1 && (t = console).warn.apply(t, [_, b.warn, e].concat(n));
			},
			logError: function (e) {
				var t;
				if (!(this.config.debug < 1)) {
					for (var i = this.config.debug >= 2 ? 'trace' : 'error', n = arguments.length, o = new Array(n > 1 ? n - 1 : 0), r = 1; r < n; r++) o[r - 1] = arguments[r];
					(t = console)[i].apply(t, [_, b.error, e].concat(o));
				}
			},
		};
	var T = (function () {
	...
	function P(e, t, i) {
		...
		return (
			(t = +t || 0),
			E(i) && ((u = !!i.leading), (r = (h = 'maxWait' in i) ? Math.max(+i.maxWait || 0, t) : r), (d = 'trailing' in i ? !!i.trailing : d)),
			(C.cancel = function () {
				void 0 !== a &&
					(function (e) {
	...
	(x.createDom = function () {
		...
		(x.createImgBtn = function (e, t, i, n) {
			...
			((a.style.backgroundImage = 'url("'.concat(t, '")')), i && n) &&
				(['px', 'rem', 'em', 'pt', 'dp', 'vw', 'vh', 'vm', '%'].every(function (e) {
					return !(i.indexOf(e) > -1 && n.indexOf(e) > -1) || ((o = parseFloat(i.slice(0, i.indexOf(e)).trim())), (r = parseFloat(n.slice(0, n.indexOf(e)).trim())), (s = e), !1);
				}),
		...
		(x.getBuffered2 = function (e) {
			for (var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0.5, i = [], n = 0; n < e.length; n++) i.push({ start: e.start(n) < 0.5 ? 0 : e.start(n), end: e.end(n) });
			i.sort(function (e, t) {
		...
		(x.getEventPos = function (e) {
			...
			return e.touches && e.touches.length > 0 && (e = e.touches[0]), { x: e.x / t, y: e.y / t, clientX: e.clientX / t, clientY: e.clientY / t, offsetX: e.offsetX / t, offsetY: e.offsetY / t, pageX: e.pageX / t, pageY: e.pageY / t };
		}),
		...
		(x.generateSessionId = function () {
			...
			(t += e), window.performance && 'function' == typeof window.performance.now && (t += parseInt(window.performance.now()));
		...
		(x.createEvent = function (e) {
			var t;
			return 'function' == typeof window.Event ? (t = new Event(e)) : (t = document.createEvent('Event')).initEvent(e, !0, !0), t;
		}),
		...
		(x.getTransformStyle = function () {
			var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { x: 0, y: 0, scale: 1, rotate: 0 },
				t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : '',
				i = { scale: ''.concat(e.scale || 1), translate: ''.concat(e.x || 0, '%, ').concat(e.y || 0, '%'), rotate: ''.concat(e.rotate || 0, 'deg') },
				n = Object.keys(i);
			return (
				n.forEach(function (e) {
					var n = new RegExp(''.concat(e, '\\([^\\(]+\\)'), 'g'),
						o = ''.concat(e, '(').concat(i[e], ')');
					n.test(t) ? ((n.lastIndex = -1), (t = t.replace(n, o))) : (t += ''.concat(o, ' '));
				}),
				t
			);
		}),
		...
		(x.getOffsetCurrentTime = function (e, t) {
			var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : -1,
				n = -1;
			if ((n = i >= 0 && i < t.length ? i : x.getIndexByTime(e, t)) < 0) return -1;
			var o = t.length,
				r = t[n],
				s = r.start,
				a = r.end,
	...
	var L = /(Android)\s([\d.]+)/,
		...
		O = {
			...
			get browser() {
				...
				var e = navigator.userAgent.toLowerCase(),
					t = { ie: /rv:([\d.]+)\) like gecko/, firefox: /firefox\/([\d.]+)/, chrome: /chrome\/([\d.]+)/, opera: /opera.([\d.]+)/, safari: /version\/([\d.]+).*safari/ };
				return [].concat(
			...
			get os() {
				...
				return { isTablet: r, isPhone: s, isIpad: l, isIos: s || l, isAndroid: n, isPc: a, isSymbian: i, isWindowsPhone: t, isFireFox: o };
			},
			get osVersion() {
			...
			isSupportMP4: function () {
				...
				return (
					'function' == typeof t.canPlayType &&
						A.map(function (i) {
							'probably' === t.canPlayType('video/mp4; codecs="'.concat(i, '"')) && ((e.isSupport = !0), (e.mime += '||'.concat(i)));
						}),
			...
			probeConfigSupported: function (e) {
				...
				if (navigator.mediaCapabilities && navigator.mediaCapabilities.decodingInfo) return navigator.mediaCapabilities.decodingInfo(e);
				var i = e.video || {},
					n = e.audio || {};
				try {
		...
		D = '3.0.10',
		R = { 1: 'media', 2: 'media', 3: 'media', 4: 'media', 5: 'media', 6: 'media' },
		M = { 1: 5101, 2: 5102, 3: 5103, 4: 5104, 5: 5105, 6: 5106 },
		j = r(function e(t) {
			var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { errorType: '', errorCode: 0, errorMessage: '', originError: '', ext: {}, mediaError: null };
			n(this, e);
			...
			if (t.media) {
				...
				M[p] && (p = M[p]);
				var g = { playerVersion: D, currentTime: a, duration: s, ended: l, readyState: d, networkState: f, src: c || u, errorType: i.errorType, errorCode: p, message: i.errorMessage || r.message, mediaError: r, originError: i.originError ? i.originError.stack : '', host: x.getHostFromUrl(c || u) };
				return (
					i.ext &&
			...
			if (arguments.length > 1) {
				for (var v = { playerVersion: D, domain: document.domain }, y = ['errorType', 'currentTime', 'duration', 'networkState', 'readyState', 'src', 'currentSrc', 'ended', 'errd', 'errorCode', 'mediaError'], m = 0; m < arguments.length; m++) v[y[m]] = arguments[m];
	...
	var De = (function (e) {
			...
			function i(e) {
				var o;
				n(this, i), ((o = t.call(this, e))._hasStart = !1), (o._currentTime = 0), (o._duration = 0), (o._internalOp = {}), (o._lastMuted = !1), (o.vtype = 'MP4'), (o._rate = -1), (o.mediaConfig = Object.assign({}, { controls: !1, autoplay: e.autoplay, playsinline: e.playsinline, 'x5-playsinline': e.playsinline, 'webkit-playsinline': e.playsinline, 'x5-video-player-fullscreen': e['x5-video-player-fullscreen'] || e.x5VideoPlayerFullscreen, 'x5-video-orientation': e['x5-video-orientation'] || e.x5VideoOrientation, airplay: e.airplay, 'webkit-airplay': e.airplay, tabindex: 0 | e.tabindex, mediaType: e.mediaType || 'video', 'data-index': -1 }, e.videoConfig, e.videoAttributes));
				var r = e['x5-video-player-type'] || e.x5VideoPlayerType;
				return O.isWeixin && O.os.isAndroid && r && ((o.mediaConfig['x5-video-player-type'] = r), delete o.mediaConfig.playsinline, delete o.mediaConfig['webkit-playsinline'], delete o.mediaConfig['x5-playsinline']), e.loop && (o.mediaConfig.loop = 'loop'), e.autoplayMuted && !Object.prototype.hasOwnProperty.call(o.mediaConfig, 'muted') && (o.mediaConfig.muted = !0), (o.media = x.createDom(o.mediaConfig.mediaType, '', o.mediaConfig, '')), e.defaultPlaybackRate && (o.media.defaultPlaybackRate = o.media.playbackRate = e.defaultPlaybackRate), 'Number' === x.typeOf(e.volume) && (o.volume = e.volume), e.autoplayMuted && ((o.media.muted = !0), (o._lastMuted = !0)), e.autoplay && (o.media.autoplay = !0), (o._interval = {}), (o.mediaEventMiddleware = {}), o.attachVideoEvents(), o;
			}
			return (
				r(i, [
					{
						...
						value: function () {
							...
							this._evHandlers ||
								(this._evHandlers = Ee.map(function (t) {
									...
									return 'function' == typeof e[i] && e.on(t, e[i]), s({}, t, Oe(t, e));
								})),
						...
						value: function (e, t) {
							...
							e.removeAttribute('src'),
								...
								t.forEach(function (e, t) {
									i.media.appendChild(x.createDom('source', '', { src: ''.concat(e.src), type: ''.concat(e.type || ''), 'data-index': t + 1 }));
								});
							var n = e.children;
							if (n) {
								(this._videoSourceCount = n.length),
									...
									(this._vLoadeddata = function (e) {
										i.emit(Se, { src: e.target.currentSrc, host: x.getHostFromUrl(e.target.currentSrc) });
									});
								...
								!this._sourceError &&
									(this._sourceError = function (e) {
										...
										if ((i._videoSourceIndex--, 0 === i._videoSourceIndex || t >= i._videoSourceCount)) {
											var n = { code: 4, message: 'sources_load_error' };
											o ? o.error(e, n) : i.errorHandler('error', n);
										}
										var r = R[4];
										i.emit(xe, new j(i, { errorType: r, errorCode: 4, errorMessage: 'sources_load_error', mediaError: { code: 4, message: 'sources_load_error' }, src: e.target.src }));
									});
						...
						value: function (e) {
							...
							if (this.media && (this.media.error || t)) {
								var i = this.media.error || t,
									n = i.code ? R[i.code] : 'other';
								i.message;
								this.media.currentSrc || (i = { code: 6, message: 'empty_src' }), this.emit(e, new j(this, { errorType: n, errorCode: i.code, errorMessage: i.message || '', mediaError: i }));
							}
						},
					},
					{
						key: 'destroy',
						value: function () {
							for (var e in (this.media && (this.media.pause && (this.media.pause(), (this.media.muted = !0)), this.media.removeAttribute('src'), this.media.load()), (this._currentTime = 0), (this._duration = 0), (this.mediaConfig = null), this._interval)) Object.prototype.hasOwnProperty.call(this._interval, e) && (clearInterval(this._interval[e]), (this._interval[e] = null));
							this.detachVideoEvents(), (this.media = null), (this.mediaEventMiddleware = {}), this.removeAllListeners();
						},
					},
					{
						key: 'video',
					...
					},
					{
						...
						value: function (e) {
							...
							if (e) for (var n = 0, o = e.length; n < o && ((t[0] = e.start(n)), (t[1] = e.end(n)), !(t[0] <= i && i <= t[1])); n++);
					...
					},
					{
						...
						get: function () {
							...
							for (var i = 0; i < t.length; i++) if ((t.start(i) <= this.currentTime || t.start(i) < 0.1) && t.end(i) >= this.currentTime) return { start: t.start(i), end: t.end(i) };
							return e;
						},
					},
					{
					...
					},
					{
						...
						set: function (e) {
							this.media && (this.emit(ce, e), this.emit(z), (this._currentTime = 0), (this._duration = 0), x.isMSE(this.media) ? this.onWaiting() : (this._detachSourceEvents(this.media), 'Array' === x.typeOf(e) ? this._attachSourceEvents(this.media, e) : e ? (this.media.src = e) : this.media.removeAttribute('src'), this.load()));
						},
					},
					{
						key: 'volume',
					...
					},
					{
						key: 'emit',
						value: function (e, t) {
							for (var n, o = arguments.length, r = new Array(o > 2 ? o - 2 : 0), s = 2; s < o; s++) r[s - 2] = arguments[s];
		...
		Re = (function () {
			function e() {
				var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { name: 'xgplayer', version: 1, db: null, ojstore: { name: 'xg-m4a', keypath: 'vid' } };
				n(this, e), (this.indexedDB = window.indexedDB || window.webkitindexedDB), (this.IDBKeyRange = window.IDBKeyRange || window.webkitIDBKeyRange), (this.myDB = t);
			}
			return (
				r(e, [
					{
						...
						value: function (e) {
							...
							(o.onerror = function (e) {}),
								...
								(o.onupgradeneeded = function (e) {
									...
									e.target.transaction, t.objectStoreNames.contains(i.myDB.ojstore.name) || t.createObjectStore(i.myDB.ojstore.name, { keyPath: i.myDB.ojstore.keypath });
								});
						},
					},
					{
					...
					},
					{
						key: 'addData',
						value: function (e, t) {
							for (var i, n = this.myDB.db.transaction(e, 'readwrite').objectStore(e), o = 0; o < t.length; o++) ((i = n.add(t[o])).onerror = function () {}), (i.onsuccess = function () {});
						},
					},
					{
						key: 'putData',
						value: function (e, t) {
							for (var i, n = this.myDB.db.transaction(e, 'readwrite').objectStore(e), o = 0; o < t.length; o++) ((i = n.put(t[o])).onerror = function () {}), (i.onsuccess = function () {});
						},
					},
					{
						key: 'getDataByKey',
		...
		Me = ['fullscreenchange', 'webkitfullscreenchange', 'mozfullscreenchange', 'MSFullscreenChange'],
		je = ['requestFullscreen', 'webkitRequestFullscreen', 'mozRequestFullScreen', 'msRequestFullscreen'],
		Ne = ['exitFullscreen', 'webkitExitFullscreen', 'mozCancelFullScreen', 'msExitFullscreen'],
		Fe = 'data-xgplayerid';
	function He(e, t, i) {
			...
			function () {
				...
				if (i.pre)
					try {
						...
						throw ((l.message = '[pluginName: '.concat(this.pluginName, ':').concat(e, ':pre error] >> ').concat(l.message)), l);
					}
					...
					try {
						...
						a
							? a.then
								...
								: He.apply(void 0, [this, t, i.next].concat(Array.prototype.slice.call(arguments)))
							: void 0 === a && He.apply(void 0, [this, t, i.next].concat(Array.prototype.slice.call(arguments)));
					} catch (l) {
						throw ((l.message = '[pluginName: '.concat(this.pluginName, ':').concat(e, '] >> ').concat(l.message)), l);
					}
				else He.apply(void 0, [this, t, i.next].concat(Array.prototype.slice.call(arguments)));
			}.bind(this)
		);
	}
	function Ue(e, t) {
		var i = this.__hooks;
		if (i) return i.hasOwnProperty(e) ? (i && (i[e] = t), !0) : (console.warn('has no supported hook which name ['.concat(e, ']')), !1);
	}
	function Ve(e, t) {
		var i = this.__hooks;
		i && delete i[e];
	...
	function Ge(e) {
		if (this.plugins && this.plugins[e.toLowerCase()]) {
			for (var t = this.plugins[e.toLowerCase()], i = arguments.length, n = new Array(i > 1 ? i - 1 : 0), o = 1; o < i; o++) n[o - 1] = arguments[o];
	...
	var Xe = (function () {
		function e(t) {
			n(this, e), x.checkIsFunction(this.beforeCreate) && this.beforeCreate(t), ze(this), (this.__args = t), (this.__events = {}), (this.__onceEvents = {}), (this.config = t.config || {}), (this.player = null), (this.playerConfig = {}), (this.pluginName = ''), this.__init(t);
		}
		return (
			r(
				e,
				[
					...
					},
					{
						...
						get: function () {
							...
							return !this.playerConfig || ('touch' !== this.playerConfig.domEventType && 'mouse' !== this.playerConfig.domEventType) || (e = this.playerConfig.domEventType), e;
						},
					},
					{
						key: 'on',
					...
					},
					{
						...
						value: function (e, t) {
							for (var i = arguments.length, n = new Array(i > 2 ? i - 2 : 0), o = 2; o < i; o++) n[o - 2] = arguments[o];
							return Ve.call.apply(Ve, [this].concat(Array.prototype.slice.call(arguments)));
						},
					},
					{
						key: 'registerPlugin',
	...
	if ('undefined' != typeof Element && !Element.prototype.matches) {
		...
		Ze.matches = Ze.matchesSelector || Ze.mozMatchesSelector || Ze.msMatchesSelector || Ze.oMatchesSelector || Ze.webkitMatchesSelector;
	}
	var Je = function (e, t) {
		for (; e && 9 !== e.nodeType; ) {
	...
	var et = function (e, t, i, n, o) {
		...
		it = { ROOT: 'root', ROOT_LEFT: 'rootLeft', ROOT_RIGHT: 'rootRight', ROOT_TOP: 'rootTop', CONTROLS_LEFT: 'controlsLeft', CONTROLS_RIGTH: 'controlsRight', CONTROLS_RIGHT: 'controlsRight', CONTROLS_CENTER: 'controlsCenter', CONTROLS: 'controls' };
	function nt(e) {
	...
	function ot(e, t) {
		...
		if (nt(e) || nt(e.url)) return (n.src = nt(e) ? e : e.url || ''), (r = x.createDom(e.tag || 'img', '', n, 'xg-img '.concat(i)));
			...
			try {
				return (r = e()) instanceof window.Element
					? (x.addClass(r, i),
					  ...
					  r)
					: (w.logWarn('warn>>icons.'.concat(t, ' in config of plugin named [').concat(o, '] is a function mast return an Element Object')), null);
			} catch (s) {
				return w.logError('Plugin named ['.concat(o, ']:createIcon'), s), null;
			}
		return 'string' == typeof e ? x.createDomFromHtml(e, n, i) : (w.logWarn('warn>>icons.'.concat(t, ' in config of plugin named [').concat(o, '] is invalid')), null);
	}
	function rt(e, t) {
					...
					[
						{
							...
							value: function (e) {
								if ((p(l(o.prototype), '__init', this).call(this, e), e.root)) {
									var t = e.root,
										i = null;
									(this.icons = {}), (this.root = null), (this.parent = null), rt(this.registerIcons() || {}, this), (this.langText = {});
									var n,
										r,
									...
									try {
										...
										throw (w.logError('Plugin:'.concat(this.pluginName, ':render'), h), new Error('Plugin:'.concat(this.pluginName, ':render:').concat(h.message)));
									}
									...
									var c = this.config.attr || {},
										u = this.config.style || {};
									this.setAttr(c), this.setStyle(u), this.config.index && this.root.setAttribute('data-index', this.config.index), this.__registerChildren();
								}
							},
						},
						{
									...
									t &&
										...
										Object.keys(t).map(function (n) {
											var o,
												...
												a = t[s],
												l = { root: e.root };
											'function' == typeof a ? ((o = e.config[s] || {}), (r = a)) : 'object' === i(a) && 'function' == typeof a.plugin && ((o = a.options ? x.deepCopy(e.config[s] || {}, a.options) : e.config[s] || {}), (r = a.plugin)), (l.config = o), void 0 !== o.index && (l.index = o.index), o.root && (l.root = o.root), e.registerPlugin(r, l, s);
										});
								}
							},
						},
						{
							...
							value: function (e) {
								...
								t &&
									(function e(t, i) {
										for (var n = 0; n < t.children.length; n++) t.children[n].children.length > 0 ? e(t.children[n], i) : i(t.children[n]);
									})(t, function (t) {
						...
						},
						{
							key: 'show',
							value: function (e) {
								if (this.root) return (this.root.style.display = void 0 !== e ? e : 'block'), 'none' === window.getComputedStyle(this.root, null).getPropertyValue('display') ? (this.root.style.display = 'block') : void 0;
							},
						},
						{
							key: 'hide',
						...
						},
						{
							...
							value: function (e, t) {
								...
								if (arguments.length < 2 && arguments[0] instanceof window.Element) return this.root.appendChild(arguments[0]);
					...
					[
						{
							...
							value: function (e, t) {
								...
								if (n) {
									...
									return r ? ('afterend' === l ? t.appendChild(e) : t.insertBefore(e, a)) : a.insertAdjacentHTML(l, e), 'afterend' === l ? t.children[t.children.length - 1] : t.children[s];
								}
						...
						(this.observer = new window.ResizeObserver(
							(function (e, t, i) {
								var n = !0,
									o = !0;
								if ('function' != typeof e) throw new TypeError('Expected a function');
								return E(i) && ((n = 'leading' in i ? !!i.leading : n), (o = 'trailing' in i ? !!i.trailing : o)), P(e, t, { leading: n, trailing: o, maxWait: t });
				...
				r(e, [
					{
						...
						value: function (e, t) {
							if (this.observer) {
								...
								for (var i = e.getAttribute(Fe), n = this.__handlers, o = -1, r = 0; r < n.length; r++) n[r] && e === n[r].target && (o = r);
								o > -1 ? (this.__handlers[o].handler = t) : this.__handlers.push({ target: e, handler: t, playerId: i });
							}
						},
					},
					{
	...
	var ct = {
			...
			formatPluginInfo: function (e, t) {
				var i = null,
					n = null;
				return e.plugin && 'function' == typeof e.plugin ? ((i = e.plugin), (n = e.options)) : ((i = e), (n = {})), t && (n.config = t || {}), { PLUFGIN: i, options: n };
			},
				...
				if (e && t && 'function' == typeof t && void 0 !== t.prototype) {
					...
					if (n && this.pluginGroup[n]) {
						...
						if (!t.isSupported || t.isSupported(e.config.mediaType, e.config.codecType)) {
							...
							try {
								o[s.toLowerCase()] && (this.unRegister(n, s.toLowerCase()), console.warn('the is one plugin with same pluginName ['.concat(s, '] exist, destroy the old instance')));
								var u = new t(i);
								return (o[s.toLowerCase()] = u), (o[s.toLowerCase()].func = t), u && 'function' == typeof u.afterCreate && u.afterCreate(), u;
							} catch (h) {
	...
	var dt = 1,
		...
		yt = 6,
		mt = 7,
		kt = ['ERROR', 'INITIAL', 'READY', 'ATTACHING', 'ATTACHED', 'NOTALLOW', 'RUNNING', 'ENDED', 'DESTROYED'],
		Ct = (function (e) {
			a(i, e);
			var t = d(i);
			function i() {
					...
					[
						{
							key: 'beforeCreate',
							value: function (e) {
								e.config.mode || 'mobile' !== O.device || (e.config.mode = 'flex'), e.player.config.marginControls && (e.config.autoHide = !1);
							},
						},
						{
							key: 'afterCreate',
							value: function () {
								...
								if (!i) {
									...
									'mobile' !== O.device && 'mobile' !== s && (this.bind('mouseenter', this.onMouseEnter), this.bind('mouseleave', this.onMouseLeave));
								}
							},
						},
						{
						...
						},
						{
							key: 'recoverAutoHide',
							value: function () {
								this.config.autoHide && x.addClass(this.root, ut.CONTROLS_AUTOHIDE);
							},
						},
						{
							key: 'pauseAutoHide',
						...
						},
						{
							key: 'destroy',
							value: function () {
								'mobile' !== O.device && (this.unbind('mouseenter', this.onMouseEnter), this.unbind('mouseleave', this.onMouseLeave));
							},
						},
						{
							key: 'render',
							value: function () {
								var e = this.config,
									...
									n = e.initShow;
								if (!e.disable) {
									var o = x.classNames({ 'xgplayer-controls': !0 }, { 'flex-controls': 'flex' === t }, { 'bottom-controls': 'bottom' === t }, s({}, ut.CONTROLS_AUTOHIDE, i), { 'xgplayer-controls-initshow': n || !i });
									return '<xg-controls class="'.concat(o, '" unselectable="on">\n    <xg-inner-controls class="xg-inner-controls xg-pos">\n      <xg-left-grid class="xg-left-grid">\n      </xg-left-grid>\n      <xg-center-grid class="xg-center-grid"></xg-center-grid>\n      <xg-right-grid class="xg-right-grid">\n      </xg-right-grid>\n    </xg-inner-controls>\n    </xg-controls>');
								}
							},
						},
					],
		...
		return (
			Object.keys(t).forEach(function (i) {
				var n,
					o = x.typeOf(t[i]),
					r = x.typeOf(e[i]);
				'Array' === o ? ('Array' !== r && (e[i] = []), (n = e[i]).push.apply(n, g(t[i]))) : 'Object' === o ? ('Object' !== r && (e[i] = {}), _t(e[i], t[i])) : (e[i] = t[i]);
			}),
			e
		);
	}
	function wt() {
		Object.keys(bt.lang.en).map(function (e) {
			bt.textKeys[e] = e;
		});
	}
	function Tt(e, t) {
		...
		if ((t || (t = bt), t.lang)) {
			var n = e.TEXT || {};
			'zh' === i && (i = 'zh-cn'), t.lang[i] ? _t(t.lang[i], n) : (t.langKeys.push(i), (t.lang[i] = n)), wt();
		}
	}
	Tt({ LANG: 'en', TEXT: { ERROR_TYPES: { network: { code: 1, msg: 'video download error' }, mse: { code: 2, msg: 'stream append error' }, parse: { code: 3, msg: 'parsing error' }, format: { code: 4, msg: 'wrong format' }, decoder: { code: 5, msg: 'decoding error' }, runtime: { code: 6, msg: 'grammatical errors' }, timeout: { code: 7, msg: 'play timeout' }, other: { code: 8, msg: 'other errors' } }, HAVE_NOTHING: 'There is no information on whether audio/video is ready', HAVE_METADATA: 'Audio/video metadata is ready ', HAVE_CURRENT_DATA: 'Data about the current play location is available, but there is not enough data to play the next frame/millisecond', HAVE_FUTURE_DATA: 'Current and at least one frame of data is available', HAVE_ENOUGH_DATA: 'The available data is sufficient to start playing', NETWORK_EMPTY: 'Audio/video has not been initialized', NETWORK_IDLE: 'Audio/video is active and has been selected for resources, but no network is used', NETWORK_LOADING: 'The browser is downloading the data', NETWORK_NO_SOURCE: 'No audio/video source was found', MEDIA_ERR_ABORTED: 'The fetch process is aborted by the user', MEDIA_ERR_NETWORK: 'An error occurred while downloading', MEDIA_ERR_DECODE: 'An error occurred while decoding', MEDIA_ERR_SRC_NOT_SUPPORTED: 'Audio/video is not supported', REPLAY: 'Replay', ERROR: 'Network is offline', PLAY_TIPS: 'Play', PAUSE_TIPS: 'Pause', PLAYNEXT_TIPS: 'Play next', DOWNLOAD_TIPS: 'Download', ROTATE_TIPS: 'Rotate', RELOAD_TIPS: 'Reload', FULLSCREEN_TIPS: 'Fullscreen', EXITFULLSCREEN_TIPS: 'Exit fullscreen', CSSFULLSCREEN_TIPS: 'Cssfullscreen', EXITCSSFULLSCREEN_TIPS: 'Exit cssfullscreen', TEXTTRACK: 'Caption', PIP: 'PIP', SCREENSHOT: 'Screenshot', LIVE: 'LIVE', OFF: 'Off', OPEN: 'Open', MINI_DRAG: 'Click and hold to drag', MINISCREEN: 'Miniscreen', REFRESH_TIPS: 'Please Try', REFRESH: 'Refresh', FORWARD: 'forward', LIVE_TIP: 'Live' } });
	var xt = {
			get textKeys() {
				return bt.textKeys;
			},
			...
			get lang() {
				var e = {};
				return (
					bt.langKeys.map(function (t) {
						e[t] = bt.lang[t];
					}),
					bt.lang['zh-cn'] && (e.zh = bt.lang['zh-cn'] || {}),
					e
				);
			},
			extend: function (e, t) {
				...
				if ((t || (t = bt), t.lang)) {
					...
					var n = t.lang;
					i.map(function (e) {
						'zh' === e.LANG && (e.LANG = 'zh-cn'), n[e.LANG] ? _t(n[e.LANG] || {}, e.TEXT || {}) : Tt(e, t);
					}),
						wt();
				}
			},
			...
			init: function (e) {
				...
				return _t(i.lang, bt.lang), (t = i.langKeys).push.apply(t, g(bt.langKeys)), _t(i.textKeys, bt.textKeys), i;
			},
		},
			...
			function o(e) {
				...
				s(u((t = i.call(this, a))), 'canPlayFunc', function () {
					if (t.config) {
						...
						w.logInfo('player', 'canPlayFunc, startTime', n), n && ((t.currentTime = n > t.duration ? t.duration : n), (t.config.startTime = 0)), (t.playbackRate = o), (i || t._useAutoplay) && t.mediaPlay(), t.off(K, t.canPlayFunc), t.removeClass(ut.ENTER);
					}
				}),
					s(u(t), 'onFullscreenChange', function (e, i) {
						var n = function () {
							...
							o = x.getFullScreenEl();
						t._fullActionFrom ? (t._fullActionFrom = '') : t.emit(we, { eventType: 'system', action: 'switch_fullscreen', pluginName: 'player', currentTime: t.currentTime, duration: t.duration, props: [{ prop: 'fullscreen', from: !0, to: !1 }] });
						...
						if (i || (o && (o === t._fullscreenEl || r))) n(), !t.config.closeFocusVideoFocus && t.media.focus(), (t.fullscreen = !0), t.changeFullStyle(t.root, o, ut.FULLSCREEN), t.emit(he, !0, t._fullScreenOffset), t.cssfullscreen && t.exitCssFullscreen();
							...
							s.config.needFullscreenScroll
								...
								: (!t.config.closeFocusVideoFocus && t.media.focus(), (t.fullscreen = !1), (t._fullScreenOffset = null)),
								t.cssfullscreen ? t.removeClass(ut.FULLSCREEN) : t.recoverFullStyle(t.root, t._fullscreenEl, ut.FULLSCREEN),
				...
				if (((t.userTimer = null), (t.waitTimer = null), (t._state = dt), (t.isError = !1), (t._hasStart = !1), (t.isSeeking = !1), (t.isCanplay = !1), (t._useAutoplay = !1), (t.rotateDeg = 0), (t.isActive = !1), (t.fullscreen = !1), (t.cssfullscreen = !1), (t.isRotateFullscreen = !1), (t._fullscreenEl = null), (t.timeSegments = []), (t._cssfullscreenEl = null), (t.curDefinition = null), (t._orgCss = ''), (t._fullScreenOffset = null), (t._videoHeight = 0), (t._videoWidth = 0), (t.videoPos = { pi: 1, scale: 0, rotate: -1, x: 0, y: 0, h: -1, w: -1, vy: 0, vx: 0 }), (t.sizeInfo = { width: 0, height: 0, left: 0, top: 0 }), (t._accPlayed = { t: 0, acc: 0, loopAcc: 0 }), (t._offsetInfo = { currentTime: -1, duration: 0 }), (t.innerContainer = null), (t.controls = null), (t.topBar = null), (t.root = null), (t.__i18n = xt.init(t._pluginInfoId)), O.os.isAndroid && O.osVersion > 0 && O.osVersion < 6 && (t.config.autoplay = !1), (t.database = new Re()), (t.isUserActive = !1), (t._onceSeekCanplay = null), (t._isPauseBeforeSeek = 0), (t.innerStates = { isActiveLocked: !1 }), !t._initDOM())) return console.error(new Error("can't find the dom which id is ".concat(t.config.id, ' or this.config.el does not exist'))), h(t);
				var d = t.config,
					f = d.definition,
					p = void 0 === f ? {} : f;
				if (!d.url && p.list && p.list.length > 0) {
					...
					g || ((p.defaultDefinition = p.list[0].definition), (g = p.list[0])), (t.config.url = g.url), (t.curDefinition = g);
				}
				return (
					t._bindEvents(),
					t._registerPresets(),
					...
					t.onReady && t.onReady(),
					(t.config.videoInit || t.config.autoplay) && (!t.hasStart || t.state < gt) && t.start(),
					t
				);
			}
			return (
					...
					[
						{
							...
							value: function () {
								...
								if (((this.root = this.config.id ? document.getElementById(this.config.id) : null), !this.root)) {
									...
									if (!t || 1 !== t.nodeType) return this.emit(U, new j('use', this.config.vid, { line: 32, handle: 'Constructor', msg: "container id can't be empty" })), console.error("this.confg.id or this.config.el can't be empty"), !1;
									this.root = t;
								}
								var i = ct.checkPlayerRoot(this.root);
								i && (w.logWarn('The is an Player instance already exists in this.root, destroy it and reinitialize'), i.destroy()), this.root.setAttribute(Fe, this.playerId), ct.init(this), this._initBaseDoms();
								...
								if ((this.media.setAttribute(Fe, this.playerId), this.config.controls)) {
									var s = this.config.controls.root || null,
										a = ct.register(this, Ct, { root: s });
									this.controls = a;
								}
								...
								if (
									...
									this.config.autoplay ? this.addClass(ut.ENTER) : this.addClass(ut.NO_START),
									this.config.fluid)
								) {
									var c = this.config,
										u = c.width,
									...
									var d = { width: '100%', height: '0', 'max-width': '100%', 'padding-top': ''.concat((100 * h) / u, '%') };
								...
								var f = this.root.getBoundingClientRect(),
									...
									v = f.left,
									y = f.top;
								return (this.sizeInfo.width = p), (this.sizeInfo.height = g), (this.sizeInfo.left = v), (this.sizeInfo.top = y), !0;
							},
						},
						{
							key: '_initBaseDoms',
							value: function () {
								(this.topBar = null), (this.leftBar = null), (this.rightBar = null), this.config.marginControls && ((this.innerContainer = x.createDom('xg-video-container', '', { 'data-index': -1 }, 'xg-video-container')), this.root.appendChild(this.innerContainer));
							},
						},
						{
							key: '_bindEvents',
							value: function () {
								...
								['focus', 'blur'].forEach(function (t) {
									...
									O.os.isIos && (this.media.addEventListener('webkitbeginfullscreen', this._onWebkitbeginfullscreen), this.media.addEventListener('webkitendfullscreen', this._onWebkitendfullscreen)),
						...
						},
						{
							...
							value: function (e) {
								var t = this;
								if (this.media && ((e && '' !== e && ('Array' !== x.typeOf(e) || 0 !== e.length)) || ((e = ''), this.emit(ne), w.logWarn('config.url is null, please get url and run player._startInit(url)'), !this.config.nullUrlStart))) {
									this._detachSourceEvents(this.media), 'Array' === x.typeOf(e) && e.length > 0 ? this._attachSourceEvents(this.media, e) : this.media.src && this.media.src === e ? e || this.media.removeAttribute('src') : (this.media.src = e), 'Number' === x.typeOf(this.config.volume) && (this.volume = this.config.volume);
									...
									w.logInfo('_startInit readyState', n),
										this.config.autoplay && (!x.isMSE(this.media) && this.load(), (O.os.isIpad || O.os.isPhone) && this.mediaPlay()),
										n >= 2 ? this.canPlayFunc() : this.once(K, this.canPlayFunc),
										...
										if (i.lazy && i.loader) {
											...
											return void (
												...
												(o
													...
													.catch(function (t) {
														w.logError('_registerPlugins:loadingPlugin', t), e._loadingPlugins.splice(e._loadingPlugins.indexOf(o), 1);
													}),
						...
						},
						{
							...
							value: function (e) {
								...
								switch (e) {
									case it.ROOT_RIGHT:
										this.rightBar || (this.rightBar = x.createPositionBar('xg-right-bar', this.root)), (t = this.rightBar);
										break;
									case it.ROOT_LEFT:
										this.leftBar || (this.leftBar = x.createPositionBar('xg-left-bar', this.root)), (t = this.leftBar);
										break;
									case it.ROOT_TOP:
										this.topBar || ((this.topBar = x.createPositionBar('xg-top-bar', this.root)), this.config.topBarAutoHide && x.addClass(this.topBar, ut.TOP_BAR_AUTOHIDE)), (t = this.topBar);
										break;
									default:
						...
						},
						{
							...
							value: function (e, t) {
								...
								return !o.root && 'string' == typeof a && a.indexOf('controls') > -1 ? this.controls && this.controls.registerPlugin(n, o, n.pluginName) : (o.root || (o.root = this._getRootByPosition(a)), ct.register(this, n, o));
							},
						},
						{
							key: 'deregister',
							value: function (e) {
								'string' == typeof e ? ct.unRegister(this, e) : e instanceof Xe && ct.unRegister(this, e.pluginName);
							},
						},
						{
						...
						},
						{
							...
							value: function (e) {
								var t;
								if (('string' == typeof e ? (t = e) : e instanceof Xe && (t = e.pluginName), t))
						...
						},
						{
							...
							value: function (e, t) {
								var i = this,
									n = e;
								'Object' === x.typeOf(e) && (n = e.url), (n = this.preProcessUrl(n).url);
								...
								return (
									...
									new Promise(function (e, t) {
										var s = function (e) {
												i.off('timeupdate', a), i.off('canplay', a), t(e);
											},
											a = function () {
												(i.currentTime = o), r && i.pause(), i.off('error', s), e(!0);
											};
										i.once('error', s), n ? (O.os.isAndroid ? i.once('timeupdate', a) : i.once('canplay', a), i.play()) : i.errorHandler('error', { code: 6, message: 'empty_src' });
									})
								);
							},
						},
						...
						},
						{
							...
							value: function () {
								var e = this;
								if (!this.hasStart && this.state < gt) return this.removeClass(ut.NO_START), this.addClass(ut.ENTER), this.start(), void (this._useAutoplay = !0);
								this.state < yt && (this.removeClass(ut.NO_START), !this.isCanplay && this.addClass(ut.ENTER));
								var t = p(l(o.prototype), 'play', this).call(this);
								return (
									void 0 !== t && t && t.then
										? t
												.then(function () {
													e.removeClass(ut.NOT_ALLOW_AUTOPLAY), e.addClass(ut.PLAYING), e.state < yt && (w.logInfo('>>>>playPromise.then'), e.setState(yt), e.emit(oe));
												})
												.catch(function (t) {
													if ((w.logWarn('>>>>playPromise.catch', t.name), e.media && e.media.error)) return e.onError(), void e.removeClass(ut.ENTER);
													'NotAllowedError' === t.name &&
														(e._errorTimer = x.setTimeout(
															e,
															function () {
																(e._errorTimer = null), e.emit(re), e.addClass(ut.NOT_ALLOW_AUTOPLAY), e.removeClass(ut.ENTER), e.pause(), e.setState(vt);
															},
															0
														));
												})
										: (w.logWarn('video.play not return promise'), this.state < yt && (this.setState(yt), this.removeClass(ut.NOT_ALLOW_AUTOPLAY), this.removeClass(ut.NO_START), this.removeClass(ut.ENTER), this.addClass(ut.PLAYING), this.emit(oe))),
									t
								);
							},
						},
								...
								if (this.media && !Number.isNaN(Number(e)) && this.hasStart) {
									...
									(e = e < 0 ? 0 : e > this.duration ? parseInt(this.duration, 10) : e),
										...
										(this._onceSeekCanplay = function () {
											switch ((i.removeClass(ut.ENTER), (i.isSeeking = !1), s)) {
												case 'play':
													i.play();
													break;
												case 'pause':
										...
										this.state < yt ? (this.removeClass(ut.NO_START), (this.currentTime = e), this.play()) : (this.currentTime = e);
								}
							},
						},
						{
						...
						},
						{
							...
							value: function (e, i) {
								...
								if (
									...
									var r = this.switchURL(e.url, t({ seamless: !1 !== o.seamless && 'undefined' != typeof MediaSource && 'function' == typeof MediaSource.isTypeSupported }, e));
									r && r.then
										? r.then(function () {
						...
						},
						{
							...
							value: function () {
								var e = this,
									t = [ut.NOT_ALLOW_AUTOPLAY, ut.PLAYING, ut.NO_START, ut.PAUSED, ut.REPLAY, ut.ENTER, ut.ENDED, ut.ERROR, ut.LOADING];
								(this.hasStart = !1),
									(this.isError = !1),
									(this._useAutoplay = !1),
									this.mediaPause(),
						...
						},
						{
							key: 'changeFullStyle',
							value: function (e, t, i, n) {
								e && (n || (n = ut.PARENT_FULLSCREEN), this._orgCss || (this._orgCss = x.filterStyleFromText(e)), x.addClass(e, i), t && t !== e && !this._orgPCss && ((this._orgPCss = x.filterStyleFromText(t)), x.addClass(t, n), t.setAttribute(Fe, this.playerId)));
							},
						},
						{
							key: 'recoverFullStyle',
							value: function (e, t, i, n) {
								n || (n = ut.PARENT_FULLSCREEN), this._orgCss && (x.setStyleFromCsstext(e, this._orgCss), (this._orgCss = '')), x.removeClass(e, i), t && t !== e && this._orgPCss && (x.setStyleFromCsstext(t, this._orgPCss), (this._orgPCss = ''), x.removeClass(t, n), t.removeAttribute(Fe));
							},
						},
						{
							key: 'getFullscreen',
							value: function () {
								var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.config.fullscreenTarget,
									t = this.root,
									i = this.media;
								e || (e = t), (this._fullScreenOffset = { top: x.scrollTop(), left: x.scrollLeft() }), (this._fullscreenEl = e), (this._fullActionFrom = 'get');
								var n = x.getFullScreenEl();
								if (n === this._fullscreenEl) return this.onFullscreenChange(), Promise.resolve();
								try {
						...
						},
						{
							key: 'exitFullscreen',
							value: function (e) {
								if ((this.isRotateFullscreen && this.exitRotateFullscreen(), this._fullscreenEl || x.getFullScreenEl())) {
									this.root;
									var t = this.media;
						...
						},
						{
							...
							value: function () {
								...
								var t = e ? ''.concat(ut.INNER_FULLSCREEN, ' ').concat(ut.CSS_FULLSCREEN) : ut.CSS_FULLSCREEN;
								...
								o && ((this.fullscreen = !0), this.emit(he, !0)), (this._cssfullscreenEl = e), (this.cssfullscreen = !0), this.emit(de, !0);
							},
						},
						{
							key: 'exitCssFullscreen',
							value: function () {
								var e = this._cssfullscreenEl ? ''.concat(ut.INNER_FULLSCREEN, ' ').concat(ut.CSS_FULLSCREEN) : ut.CSS_FULLSCREEN;
								if (this.fullscreen) {
									var t = this.config.fullscreen,
										i = void 0 === t ? {} : t;
									!0 === i.useCssFullscreen || ('function' == typeof i.useCssFullscreen && i.useCssFullscreen()) ? (this.recoverFullStyle(this.root, this._cssfullscreenEl, e), (this.fullscreen = !1), this.emit(he, !1)) : this.removeClass(e);
								} else this.recoverFullStyle(this.root, this._cssfullscreenEl, e);
								(this._cssfullscreenEl = null), (this.cssfullscreen = !1), this.emit(de, !1);
							},
						},
						{
							...
							value: function () {
								...
								var t = e ? ''.concat(ut.INNER_FULLSCREEN, ' ').concat(ut.ROTATE_FULLSCREEN) : ut.ROTATE_FULLSCREEN;
								(this._fullscreenEl = e || this.root), this.changeFullStyle(this.root, e, t, ut.PARENT_ROTATE_FULLSCREEN), (this.isRotateFullscreen = !0), (this.fullscreen = !0), this.setRotateDeg(90), (this._rootStyle = this.root.getAttribute('style')), (this.root.style.width = ''.concat(window.innerHeight, 'px')), this.emit(he, !0);
							},
						},
						{
							key: 'exitRotateFullscreen',
							value: function (e) {
								var t = this._fullscreenEl !== this.root ? ''.concat(ut.INNER_FULLSCREEN, ' ').concat(ut.ROTATE_FULLSCREEN) : ut.ROTATE_FULLSCREEN;
								this.recoverFullStyle(this.root, this._fullscreenEl, t, ut.PARENT_ROTATE_FULLSCREEN), (this.isRotateFullscreen = !1), (this.fullscreen = !1), this.setRotateDeg(0), this.emit(he, !1), this._rootStyle && ((this.root.style.style = this._rootStyle), (this._rootStyle = !1));
							},
						},
						{
							key: 'setRotateDeg',
						...
						},
						{
							key: 'focus',
							value: function () {
								var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { autoHide: !this.config.closeDelayBlur, delay: this.config.inactive };
								this.isActive ? this.onFocus(e) : this.emit(ee, t({ paused: this.paused, ended: this.ended }, e));
							},
						},
						{
							key: 'blur',
							value: function () {
								...
								this.isActive ? this.emit(te, t({ paused: this.paused, ended: this.ended }, e)) : this.onBlur(e);
							},
						},
						{
							key: 'onFocus',
							value: function () {
								var e = this,
									t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { autoHide: !0, delay: 3e3 },
									i = this.innerStates;
								if (((this.isActive = !0), this.removeClass(ut.INACTIVE), this.userTimer && (x.clearTimeout(this, this.userTimer), (this.userTimer = null)), void 0 !== t.isLock && (i.isActiveLocked = t.isLock), !1 === t.autoHide || !0 === t.isLock || i.isActiveLocked)) this.userTimer && (x.clearTimeout(this, this.userTimer), (this.userTimer = null));
								else {
						...
						},
						{
							...
							value: function () {
								...
								if (this.isActive && !this.innerStates.isActiveLocked) {
									...
									(this.isActive = !1), (i || n || (!this.paused && !this.ended)) && this.addClass(ut.INACTIVE);
								}
							},
						},
						{
						...
						},
						{
							key: 'onCanplay',
							value: function () {
								this.removeClass(ut.ENTER), this.removeClass(ut.ERROR), this.removeClass(ut.LOADING), (this.isCanplay = !0), this.waitTimer && x.clearTimeout(this, this.waitTimer);
							},
						},
						{
							key: 'onLoadeddata',
						...
						},
						{
							key: 'onPlay',
							value: function () {
								this.state === mt && this.setState(yt), this.removeClass(ut.PAUSED), this.ended && this.removeClass(ut.ENDED), !this.config.closePlayVideoFocus && this.focus();
							},
						},
						{
							key: 'onPause',
							value: function () {
								this.addClass(ut.PAUSED), this.updateAcc('pause'), this.config.closePauseVideoFocus || (this.userTimer && (x.clearTimeout(this, this.userTimer), (this.userTimer = null)), this.focus());
							},
						},
						{
							key: 'onEnded',
							value: function () {
								this.updateAcc('ended'), this.addClass(ut.ENDED), this.setState(mt);
							},
						},
						{
							key: 'onError',
							value: function () {
								(this.isError = !0), this.updateAcc('error'), this.removeClass(ut.NOT_ALLOW_AUTOPLAY), this.removeClass(ut.NO_START), this.removeClass(ut.ENTER), this.removeClass(ut.LOADING), this.addClass(ut.ERROR);
							},
						},
						{
							key: 'onSeeking',
							value: function () {
								this.isSeeking || this.updateAcc('seeking'), (this.isSeeking = !0), this.addClass(ut.SEEKING);
							},
						},
						{
							key: 'onSeeked',
							value: function () {
								(this.isSeeking = !1), this.waitTimer && x.clearTimeout(this, this.waitTimer), this.removeClass(ut.LOADING), this.removeClass(ut.SEEKING);
							},
						},
						{
							key: 'onWaiting',
							value: function () {
								...
								this.waitTimer && x.clearTimeout(this, this.waitTimer),
									...
									(this.waitTimer = x.setTimeout(
										this,
										function () {
											e.addClass(ut.LOADING), x.clearTimeout(e, e.waitTimer), (e.waitTimer = null);
										},
						...
						},
						{
							...
							value: function () {
								var e = this;
								(this.isError = !1),
									[ut.NO_START, ut.PAUSED, ut.ENDED, ut.ERROR, ut.REPLAY, ut.LOADING].forEach(function (t) {
										e.removeClass(t);
									});
							},
						},
						{
							key: 'onTimeupdate',
							value: function () {
								!this._videoHeight && this.media.videoHeight && this.resize(), (this.waitTimer || this.hasClass(ut.LOADING)) && this.media.readyState > 2 && (this.removeClass(ut.LOADING), x.clearTimeout(this, this.waitTimer), (this.waitTimer = null)), !this.paused && this.state < yt && this.duration && (this.setState(yt), this.emit(oe)), this._accPlayed.t || this.paused || this.ended || (this._accPlayed.t = new Date().getTime());
							},
						},
						{
							key: 'onVolumechange',
						...
						},
						{
							...
							value: function (e, i, n) {
								if (this.media && i && e) {
									...
									n.props && 'Array' !== x.typeOf(n.props) && (n.props = [n.props]), this.emit(we, t({ eventType: o, action: i, currentTime: this.currentTime, duration: this.duration, ended: this.ended, event: e }, n));
								}
							},
						},
						{
							...
							value: function (e) {
								if (this._accPlayed.t) {
									...
									(this._accPlayed.acc += t), (this._accPlayed.t = 0), ('ended' === e || this.ended) && (this._accPlayed.loopAcc = this._accPlayed.acc);
								}
							},
						},
						{
							...
							value: function (e) {
								...
								for (var i = e || this.media.currentTime || 0.2, n = t.length, o = 0; o < n; o++) if (t.start(o) <= i && t.end(o) > i) return !0;
								return !1;
							},
						},
						{
							...
							value: function () {
								...
								if (!(t < 0) || i || n) {
									...
									if ((!s && this.media.videoHeight && (s = (this.media.videoWidth / this.media.videoHeight) * 100), s)) {
										this.videoPos.pi = s;
										var a = { rotate: t },
											l = 0,
											c = 0,
											...
											v = g,
											y = p;
										if (h % 2 == 0) (u = o > 0 ? 100 / o : r > 0 ? 100 / r : 1), (a.scale = u), (l = i > 0 ? (100 - o) / 2 - i : 0), (a.y = 2 === h ? 0 - l : l), (c = n > 0 ? (100 - r) / 2 - n : 0), (a.x = 2 === h ? 0 - c : c), (this.media.style.width = ''.concat(y, 'px')), (this.media.style.height = ''.concat(v, 'px'));
										else if (h % 2 == 1) {
											v = p;
											var m = g - p;
											(c = (-m / 2 / (y = g)) * 100), (a.x = 3 === h ? c + i / 2 : c - i / 2), (l = (m / 2 / v) * 100), (a.y = 3 === h ? l + n / 2 : l - n / 2), (a.scale = u), (this.media.style.width = ''.concat(y, 'px')), (this.media.style.height = ''.concat(v, 'px'));
										}
										var k = x.getTransformStyle(a, this.media.style.transform || this.media.style.webkitTransform);
										(this.media.style.transform = k), (this.media.style.webkitTransform = k);
									}
								}
							},
						},
						{
							...
							value: function () {
								...
								if (this.media && e && e.h) {
									var t = this.videoPos;
									(t.h = 100 * e.h || 0), (t.w = 100 * e.w || 0), (t.vx = 100 * e.x || 0), (t.vy = 100 * e.y || 0), this.resizePosition();
								}
							},
						},
						{
							...
							value: function () {
								...
								if (this.media) {
									...
									var i = this.media,
										...
										s = r.fitVideoSize,
										a = r.videoFillMode;
									if ((('fill' !== a && 'cover' !== a && 'contain' !== a) || this.setAttribute('data-xgfill', a), o && n)) {
										...
										var l = this.controls && this.innerContainer ? this.controls.root.getBoundingClientRect().height : 0,
											...
											p = u,
											g = {};
										('auto' === s && d > h) || 'fixWidth' === s ? ((p = (c / h) * 1e3), this.config.fluid ? (g.paddingTop = ''.concat((100 * p) / f, '%')) : (g.height = ''.concat(p + l, 'px'))) : (('auto' === s && d < h) || 'fixHeight' === s) && ((f = (h * u) / 1e3), (g.width = ''.concat(f, 'px'))),
											this.fullscreen ||
												this.cssfullscreen ||
												Object.keys(g).forEach(function (t) {
													e.root.style[t] = g[t];
												}),
											(('fillHeight' === a && d < h) || ('fillWidth' === a && d > h)) && this.setAttribute('data-xgfill', 'cover');
						...
						},
						{
							key: 'setState',
							value: function (e) {
								w.logInfo('setState', 'state from:'.concat(kt[this.state], ' to:').concat(kt[e])), (this._state = e);
							},
						},
						{
							key: 'preProcessUrl',
							value: function (e, t) {
								...
								return !x.isBlob(e) && i && 'function' == typeof i ? i(e, t) : { url: e };
							},
						},
						{
							key: 'state',
						...
						},
						{
							...
							set: function (e) {
								'boolean' == typeof e && ((this._hasStart = e), !1 === e && this.setState(ft), this.emit('hasstart'));
							},
						},
						{
							key: 'isPlaying',
						...
						},
						{
							...
							set: function (e) {
								...
								(i.list = e),
									...
									e.forEach(function (e) {
										var r;
										(null === (r = t.curDefinition) || void 0 === r ? void 0 : r.definition) === e.definition && (n = e), i.defaultDefinition === e.definition && (o = e);
									}),
									!o && e.length > 0 && (o = e[0]),
						...
						},
						{
							...
							set: function (e) {
								0 !==
									...
									: console.error('Sorry, set lang fail, because the language ['.concat(e, '] is not supported now, list of all supported languages is [').concat(xt.langKeys.join(), '] '));
							},
						},
						{
							key: 'i18n',
						...
						},
						{
							...
							set: function (e) {
								(e = x.convertDeg(e)) % 90 == 0 && e !== this.videoPos.rotate && ((this.videoPos.rotate = e), this.resizePosition());
							},
						},
						{
							key: 'avgSpeed',
						...
						},
						{
							...
							value: function (e, t, i) {
								for (var n = arguments.length, o = new Array(n > 3 ? n - 3 : 0), r = 3; r < n; r++) o[r - 3] = arguments[r];
								return Ge.call.apply(Ge, [this].concat(Array.prototype.slice.call(arguments)));
							},
						},
						{
						...
						},
						{
							key: 'setUserActive',
							value: function (e, t) {
								'boolean' == typeof t && t !== this.muted && (this.addInnerOP('volumechange'), (this.muted = t)), ct.setCurrentUserActive(this.playerId, e);
							},
						},
					],
					[
			...
			function o() {
				...
				return (
					s(u((e = i.call.apply(i, [this].concat(r)))), '_onTimeupdate', function () {
						(e._state.isTimeUpdate = !0), e._state.autoplayStart && (w.logInfo('[xgLogger]'.concat(e.player.playerId, ' _onTimeupdate')), e._sendFF('onTimeupdate'));
					}),
					s(u(e), '_onAutoplayStart', function () {
						w.logInfo('[xgLogger]'.concat(e.player.playerId, ' _onAutoplayStart')), (e._state.autoplayStart = !0), e.vt && e._sendFF('onAutoplayStart');
					}),
					s(u(e), '_onReset', function () {
						(e._state = { autoplayStart: !1, isFFLoading: !1, isTimeUpdate: !1, isFFSend: !1, isLs: !1 }), (e.vt = 0), (e.pt = 0), (e.fvt = 0), (e.newPointTime = It()), (e.loadedCostTime = 0), (e.startCostTime = 0), (e._isSeeking = !1), (e.seekingStart = 0), (e.waitingStart = 0), (e.fixedWaitingStart = 0), (e._isWaiting = !1), e._waitTimer && x.clearTimeout(u(e), e._waitTimer), e._waittTimer && x.clearTimeout(u(e), e._waittTimer), (e._waitTimer = null), (e._waittTimer = null), (e._waitType = 0);
					}),
					s(u(e), '_onSeeking', function () {
						e.seekingStart || (e.suspendWaitingStatus('seek'), (e.seekingStart = It()), e.emitLog(jt, { start: It() }));
					}),
					s(u(e), '_onSeeked', function () {
						e.suspendSeekingStatus('seeked');
					}),
					s(u(e), '_onWaitingLoadStart', function () {
						e._isWaiting || e.vt || ((e._isWaiting = !0), (e.waitingStart = It()), (e.fixedWaitingStart = It()), (e._waitType = 1), e.emitLog(Rt, { fixedStart: e.fixedWaitingStart, start: e.waitingStart, type: 1, endType: 'loadstart' }));
					}),
					s(u(e), '_onWaiting', function () {
						!e._isWaiting &&
							...
							(e._waitTimer = x.setTimeout(
								u(e),
								function () {
									e._isWaiting && ((e.waitingStart = It()), x.clearTimeout(u(e), e._waitTimer), (e._waitTimer = null), e._startWaitTimeout(), e.emitLog(Rt, { fixedStart: e.fixedWaitingStart, start: e.waitingStart, type: e._waitType, endType: 2 === e._waitType ? 'seek' : 'playing' }));
								},
								200
							)));
					}),
								...
								this._onReset(),
									...
									this.on($, function () {
										var t = e._state,
											i = t.autoplayStart,
											n = t.isFFSend;
										(e.startCostTime = It() - e.newPointTime), w.logInfo('[xgLogger]'.concat(e.player.playerId, ' LOAD_START'), 'autoplayStart:'.concat(i, ' isFFSend:').concat(n, ' startCostTime:').concat(e.startCostTime, ' newPointTime').concat(e.newPointTime)), n || (!t.isLs && e.emitLog(At, {}), (t.isLs = !0), (t.isTimeUpdate = !1), (t.isFFLoading = !0), (e.pt = It()), (e.vt = 0), (e.fvt = 0), e._initOnceEvents(), e._onWaitingLoadStart());
									}),
									this.on(X, function () {
										(e.vt = It()), (e.fvt = e.vt - e.pt), (e.loadedCostTime = e.vt - e.newPointTime);
										var t = e._state,
											i = t.isTimeUpdate,
											n = t.isFFSend,
											o = t.autoplayStart;
										w.logInfo('[xgLogger]'.concat(e.player.playerId, ' LOADED_DATA'), 'fvt:'.concat(e.fvt, ' isTimeUpdate:').concat(e._state.isTimeUpdate, ' loadedCostTime:').concat(e.loadedCostTime)), (i || o) && e._sendFF('loadedData'), n || e.emitLog(Ot, {}), e.suspendWaitingStatus('loadeddata');
									}),
									...
									this.on(ce, function () {
										e.endState('urlChange'), w.logInfo('[xgLogger]'.concat(e.player.playerId, ' URL_CHANGE')), e._state.isFFSend && e._onReset();
									}),
									this.on([F, K], this._onPlaying),
									this.on(z, this._onWaiting),
									this.on(U, this._onError),
									this.on(Te, function () {
										w.logInfo('[xgLogger]'.concat(e.player.playerId, ' RESET')), e.endState('reset'), e._initOnceEvents(), e._onReset();
									});
							},
						},
						{
							key: '_initOnceEvents',
							value: function () {
								this.off(oe, this._onAutoplayStart), this.off(W, this._onTimeupdate), this.once(oe, this._onAutoplayStart), this.once(W, this._onTimeupdate);
							},
						},
						{
							key: '_sendFF',
							value: function (e) {
								...
								var t = this._state,
									i = t.isFFLoading,
									n = t.isFFSend;
								w.logInfo('[xgLogger]'.concat(this.player.playerId, ' _sendFF'), ''.concat(e, ' fvt:').concat(this.fvt, ' isFFLoading:').concat(i, ' !isFFSend:').concat(!n)), this.vt > 0 && i && !n && (w.logInfo('[xgLogger]'.concat(this.player.playerId, ' emitLog_firstFrame'), e), (this._state.isFFLoading = !1), (this._state.isFFSend = !0), this.emitLog(Dt, { fvt: this.fvt, costTime: this.fvt, vt: this.vt, startCostTime: this.startCostTime, loadedCostTime: this.loadedCostTime }));
							},
						},
						{
						...
						},
						{
							...
							value: function (e) {
								if (this.seekingStart) {
									...
									(this.seekingStart = 0), this.emitLog(Nt, { end: t, costTime: i, endType: e });
								}
							},
						},
						{
							...
							value: function (e) {
								if ((this._waitTimer && (x.clearTimeout(this, this._waitTimer), (this._waitTimer = null)), this._waittTimer && (x.clearTimeout(this, this._waittTimer), (this._waittTimer = null)), (this._isWaiting = !1), this.waitingStart)) {
									var t = It(),
										i = t - this.waitingStart,
										n = t - this.fixedWaitingStart,
										o = this.config.waitTimeout;
									(this._isWaiting = !1), (this.waitingStart = 0), (this.fixedWaitingStart = 0), this.emitLog(Mt, { fixedCostTime: n > o ? o : n, costTime: i > o ? o : i, type: 'loadeddata' === e ? 1 : this._waitType, endType: 2 === this._waitType ? 'seek' : e });
								}
							},
						},
						{
							...
							value: function (e, i) {
								var n = this.player;
								this.emit(_e, t({ t: It(), host: x.getHostFromUrl(n.currentSrc), vtype: n.vtype, eventType: e, currentTime: this.player.currentTime, readyState: n.video.readyState, networkState: n.video.networkState }, i));
							},
						},
					],
					[
				...
				r(
					...
					[
						...
						},
						{
							key: 'handleReplay',
							value: function (e) {
								e.preventDefault(), e.stopPropagation(), this.player.replay(), x.removeClass(this.player.root, 'replay');
							},
						},
						{
							key: 'show',
				...
				r(
					...
					[
						...
						},
						{
							key: 'registerIcons',
							value: function () {
								return { startPlay: { icon: Vt, class: 'xg-icon-play' }, startPause: { icon: Gt, class: 'xg-icon-pause' } };
							},
						},
						{
							key: 'initIcons',
								...
								this._animateId = (function (e, t) {
									...
									return (
										...
										(Wt[e].id = window.setTimeout(function () {
											i.end && i.end(), window.clearTimeout(Wt[e].id), delete Wt[e];
										}, t)),
										Wt[e].id
									);
								})('pauseplay', 400, {
									start: function () {
										...
										x.removeClass(t.root, 'interact'), !e && t.hide(), (t._animateId = null);
									},
								});
							},
						},
						{
							key: 'endAnimate',
							value: function () {
								x.removeClass(this.root, 'interact'), zt(this._animateId), (this._animateId = null);
							},
						},
						{
							key: 'switchPausePlay',
							value: function (e) {
								var t = this.player;
								(e.cancelable && e.preventDefault(), e.stopPropagation(), t.state < ft) || (this.player.paused || t.state !== yt ? t.play() : t.pause());
							},
						},
						{
							key: 'onPlayPause',
							value: function (e) {
								...
								if (i && !(i.state < yt) && this.autoPlayStart) {
									...
									if ('auto' !== t.mode) {
										if ((t.isShowPause && i.paused && !i.ended) || (t.isShowEnd && i.ended)) return this.switchStatus(), this.show(), void this.endAnimate();
						...
						},
						{
							key: 'destroy',
							value: function () {
								this.unbind(['click', 'touchend'], this.clickHandler), zt(this._animateId);
							},
						},
						{
							key: 'render',
	...
	var Jt = ['paddingLeft', 'paddingRight', 'paddingTop', 'paddingBottom', 'marginLeft', 'marginRight', 'marginTop', 'marginBottom', 'borderLeftWidth', 'borderRightWidth', 'borderTopWidth', 'borderBottomWidth'],
		$t = Jt.length;
	function Qt(e) {
		if (('string' == typeof e && (e = document.querySelector(e)), e && 'object' === i(e) && e.nodeType)) {
			...
			if ('none' === t.display)
				return (function () {
					for (var e = { width: 0, height: 0, innerWidth: 0, innerHeight: 0, outerWidth: 0, outerHeight: 0 }, t = 0; t < $t; t++) e[Jt[t]] = 0;
					return e;
				})();
			var n = {};
			(n.width = e.offsetWidth), (n.height = e.offsetHeight);
			for (var o = (n.isBorderBox = 'border-box' === t.boxSizing), r = 0; r < $t; r++) {
				var s = Jt[r],
					a = t[s],
					l = parseFloat(a);
			...
			var y = Zt(t.height);
			return !1 !== y && (n.height = y + (g ? 0 : u + p)), (n.innerWidth = n.width - (c + f)), (n.innerHeight = n.height - (u + p)), (n.outerWidth = n.width + h), (n.outerHeight = n.height + d), n;
		}
	}
	function ei(e, t) {
	...
	var ti = 'dragStart',
		ii = 'dragMove',
		ni = 'dragEnded',
		oi = { mousedown: ['mousemove', 'mouseup'], touchstart: ['touchmove', 'touchend', 'touchcancel'], pointerdown: ['pointermove', 'pointerup', 'pointercancel'] },
		ri = (function (e) {
			a(i, e);
			var t = d(i);
			function i(e) {
				...
				r(i, [
					...
					},
					{
						...
						value: function (e) {
							...
							this.dragStart(e, t), (this.touchIdentifier = void 0 !== t.pointerId ? t.pointerId : t.identifier), e.preventDefault();
						},
					},
					{
						key: 'ontouchmove',
					...
					},
					{
						...
						value: function (e, t) {
							if (this._root && !this.isDown && this.isEnabled) {
								...
								var i = Qt(this._root);
								(this.startPos.x = this.position.x), (this.startPos.y = this.position.y), (this.startPos.maxY = window.innerHeight - i.height), (this.startPos.maxX = window.innerWidth - i.width), this.setLeftTop(), (this.isDown = !0), this._bindPostStartEvents(e);
							}
						},
					},
					{
						key: 'dragRealStart',
						value: function (e, t) {
							(this.isDragging = !0), this.animate(), this.emit(ti, this.startPos);
						},
					},
					{
						key: 'dragEnd',
						value: function (e, t) {
							this._root && (this._unbindPostStartEvents(), this.isDragging && ((this._root.style.transform = ''), this.setLeftTop(), this.emit(ni)), this.presetInfo());
						},
					},
					{
						...
						value: function (e, t) {
							if (((e = e || window.event), this.isDown)) {
								var i = this.startPos,
									...
									s = r.x,
									a = r.y;
								(s = this.checkContain('x', s, n)), (a = this.checkContain('y', a, o)), (this.position.x = n + s), (this.position.y = o + a), (this.dragPoint.x = s), (this.dragPoint.y = a), this.emit(ii, this.position);
							}
						},
					},
					{
					...
					},
					{
						key: 'presetInfo',
						value: function () {
							(this.isDragging = !1), (this.startPos = { x: 0, y: 0 }), (this.dragPoint = { x: 0, y: 0 }), (this.isDown = !1);
						},
					},
					{
						key: 'destroy',
						value: function () {
							this._unbindStartEvent(), this._unbindPostStartEvents(), this.isDragging && this.dragEnd(), this.removeAllListeners(), (this._handlerDom = null);
						},
					},
					{
						key: 'hasDragStarted',
					...
					},
					{
						...
						value: function () {
							...
							(this.position.x = Number.isNaN(t) ? 0 : t), (this.position.y = Number.isNaN(i) ? 0 : i), this._addTransformPosition(e);
						},
					},
					{
				...
				n(this, i),
					...
					s(u(o), 'onScroll', function (e) {
						if (!((!window.scrollY && 0 !== window.scrollY) || Math.abs(window.scrollY - o.pos.scrollY) < 50)) {
							...
							(t += o.config.scrollTop), (o.pos.scrollY = window.scrollY), window.scrollY > t + 5 ? !o.isMini && !o.isClose && o.getMini() : window.scrollY <= t && (o.isMini && o.exitMini(), (o.isClose = !1));
						}
					}),
					(o.isMini = !1),
					(o.isClose = !1);
				var r = u(o).config;
				return (o.pos = { left: r.left < 0 ? window.innerWidth - r.width - 20 : r.left, top: r.top < 0 ? window.innerHeight - r.height - 20 : r.top, height: o.config.height, width: o.config.width, scrollY: window.scrollY || 0 }), (o.lastStyle = null), o;
			}
			return (
				r(
					i,
						...
						},
						{
							...
							value: function () {
								...
								if (!this.config.disable) {
									...
									this.bind('.mini-cancel-btn', n, this.onCancelClick), this.bind('.play-icon', n, this.onCenterClick), this.config.disableDrag || (this._draggabilly = new ri(this.player.root, { handle: this.root })), this.config.isScrollSwitch && window.addEventListener('scroll', this.onScroll);
								}
							},
						},
						{
							key: 'registerIcons',
							value: function () {
								return { play: { icon: Vt, class: 'xg-icon-play' }, pause: { icon: Gt, class: 'xg-icon-pause' } };
							},
						},
						{
							key: 'initIcons',
						...
						},
						{
							...
							value: function () {
								...
								x.removeClass(t.root, 'xgplayer-mini'),
									...
									(this.lastStyle = null),
									i.fluid && ((t.root.style.width = '100%'), (t.root.style.height = '0'), (t.root.style['padding-top'] = ''.concat((100 * i.height) / i.width, '%'))),
									this.emit(fe, !1),
					...
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return { index: 10, disable: !1, width: 320, height: 180, left: -1, top: -1, isShowIcon: !1, isScrollSwitch: !1, scrollTop: 0, disableDrag: !1 };
							},
						},
					]
				),
		...
		ai = { mouseenter: 'onMouseEnter', mouseleave: 'onMouseLeave', mousemove: 'onMouseMove' },
							...
							(!o.closeVideoClick && e._clickCount < 2
								...
								: ((e._clickCount = 0),
								  ...
								  qe(
										...
										li[1],
										function (t, i) {
											e.emitUserAction(i.e, 'switch_fullscreen', { props: 'fullscreen', from: n.fullscreen, to: !n.fullscreen }), n.fullscreen ? n.exitFullscreen() : n.getFullscreen();
										},
				...
				r(
					...
					[
						...
						},
						{
							...
							value: function (e) {
								var t = this.player;
								this.emitUserAction(e, 'switch_play_pause', { props: 'paused', from: t.paused, to: !t.paused }), t.ended ? t.duration !== 1 / 0 && t.duration > 0 && t.replay() : t.paused ? t.play() : t.pause();
							},
						},
						{
							key: 'onContextmenu',
							value: function (e) {
								(e = e || window.event).preventDefault && e.preventDefault(), e.stopPropagation ? e.stopPropagation() : ((e.returnValue = !1), (e.cancelBubble = !0));
							},
						},
						{
							key: 'destroy',
		...
		gi = 'touchstart',
		vi = 'touchend',
		yi = { start: 'touchstart', end: 'touchend', move: 'touchmove', cancel: 'touchcancel' },
		mi = { start: 'mousedown', end: 'mouseup', move: 'mousemove', cancel: 'mouseleave' };
	function ki(e) {
			...
			n(this, e),
				s(this, 'onTouchStart', function (e) {
					var t = i._pos,
						n = i.root,
						o = ki(e.touches);
					(t.x = o ? parseInt(o.pageX, 10) : e.pageX), (t.y = o ? parseInt(o.pageX, 10) : e.pageX), (t.start = !0), i.__setPress(e), n.addEventListener(i.events.end, i.onTouchEnd), n.addEventListener(i.events.cancel, i.onTouchCancel), n.addEventListener(i.events.move, i.onTouchMove), i.trigger(gi, e);
				}),
				...
				s(this, 'onTouchEnd', function (e) {
					var t = i._pos,
						n = i.root;
					i.__clearPress(), n.removeEventListener(i.events.cancel, i.onTouchCancel), n.removeEventListener(i.events.end, i.onTouchEnd), n.removeEventListener(i.events.move, i.onTouchMove), (e.moving = t.moving), (e.press = t.press), t.press && i.trigger(hi, e), i.trigger(vi, e), !t.press && !t.moving && i.__setDb(e), (t.press = !1), (t.start = !1), (t.moving = !1);
				}),
				s(this, 'onTouchMove', function (e) {
					var t = i._pos,
						...
						a = r - t.x,
						l = s - t.y;
					(Math.abs(l) < n.miniStep && Math.abs(a) < n.miniStep) || (i.__clearPress(), t.press && i.trigger(hi, e), (t.press = !1), (t.moving = !0), i.trigger(pi, e));
				}),
				(this._pos = { moving: !1, start: !1, x: 0, y: 0 }),
				(this.config = { pressDelay: 600, dbClickDelay: 200, disablePress: !1, disableDbClick: !1, miniStep: 2, needPreventDefault: !0 }),
			...
			r(e, [
				...
				},
				{
					...
					value: function (e) {
						var t = this,
							i = this.config;
						if (this.dbIntrvalId) return this.__clearDb(), void this.trigger(di, e);
						this.dbIntrvalId = setTimeout(function () {
							t.__clearDb(), t._pos.start || t._pos.press || t._pos.moving || t.trigger(fi, e);
						}, i.dbClickDelay);
					},
				},
				{
				...
				return (
					...
					s(u((o = t.call(this, e))), 'onTouchStart', function (e) {
						...
						if (a && !n.disableGesture && o.duration > 0 && !i.ended) {
							(r.isStart = !0), x.checkIsFunction(s.disableSwipeHandler) && s.disableSwipeHandler(), (o.find('.xg-dur').innerHTML = x.format(o.duration));
							var l = o.root.getBoundingClientRect();
							90 === i.rotateDeg ? ((r.top = l.left), (r.left = l.top), (r.width = l.height), (r.height = l.width)) : ((r.top = l.top), (r.left = l.left), (r.width = l.width), (r.height = l.height));
							var c = parseInt(a.pageX - r.left, 10),
								h = parseInt(a.pageY - r.top, 10);
							(r.x = 90 === i.rotateDeg ? h : c), (r.y = 90 === i.rotateDeg ? c : h), (r.scopeL = n.scopeL * r.width), (r.scopeR = (1 - n.scopeR) * r.width), (r.scopeM1 = (r.width * (1 - n.scopeM)) / 2), (r.scopeM2 = r.width - r.scopeM1);
						}
					}),
						...
						if (t && !r.disableGesture && o.duration && n.isStart) {
							...
							if (Math.abs(d - n.x) > a || Math.abs(f - n.y) > a) {
								var p = d - n.x,
									g = f - n.y,
									v = n.scope;
								if ((-1 === v && (0 === (v = o.checkScope(d, f, p, g, n)) && (l ? s.blur() : s.focus({ autoHide: !1 }), !n.time && (n.time = parseInt(1e3 * s.currentTime, 10) + 1e3 * o.timeOffset)), (n.scope = v)), -1 === v || (v > 0 && !r.gestureY) || (0 === v && !r.gestureX))) return;
					...
					s(u(o), 'onRootTouchMove', function (e) {
						!o.config.disableGesture && o.config.gestureX && o.checkIsRootTarget(e) && (e.stopPropagation(), o.pos.isStart ? o.onTouchMove(e) : o.onTouchStart(e));
					}),
					s(u(o), 'onRootTouchEnd', function (e) {
						o.pos.isStart && o.checkIsRootTarget(e) && (e.stopPropagation(), o.onTouchEnd(e));
					}),
					(o.pos = { isStart: !1, x: 0, y: 0, time: 0, volume: 0, rate: 1, light: 0, width: 0, height: 0, scopeL: 0, scopeR: 0, scopeM1: 0, scopeM2: 0, scope: -1 }),
					(o.timer = null),
					o
				);
			}
				...
				r(
					...
					[
						...
						},
						{
							key: 'registerIcons',
							value: function () {
								return { seekTipIcon: { icon: bi, class: 'xg-seek-pre' } };
							},
						},
						{
							key: 'afterCreate',
							value: function () {
								...
								var t = this.playerConfig,
									i = this.config,
									n = this.player;
								!0 === t.closeVideoDblclick && (i.closedbClick = !0), this.resetPos(), x.isUndefined(t.disableGesture) || (i.disableGesture = !!t.disableGesture), this.appendChild('.xg-seek-icon', this.icons.seekTipIcon), (this.xgMask = x.createDom('xg-mask', '', {}, 'xgmask')), n.root.appendChild(this.xgMask), this.initCustomStyle(), this.registerThumbnail();
								var o = 'mouse' === this.domEventType ? 'mouse' : 'touch';
								(this.touch = new Ci(this.root, { eventType: o, needPreventDefault: !this.config.disableGesture })),
								...
								var r = { touchstart: 'onTouchStart', touchmove: 'onTouchMove', touchend: 'onTouchEnd', press: 'onPress', pressend: 'onPressEnd', click: 'onClick', doubleclick: 'onDbClick' };
								if (
									(Object.keys(r).map(function (t) {
						...
						},
						{
							...
							value: function () {
								var e = (this.playerConfig || {}).commonStyle,
									t = e.playedColor,
									i = e.progressColor;
								t && ((this.find('.xg-curbar').style.backgroundColor = t), (this.find('.xg-cur').style.color = t)), i && ((this.find('.xg-bar').style.backgroundColor = i), (this.find('.time-preview').style.color = i)), this.config.disableTimeProgress && x.addClass(this.find('.xg-timebar'), 'hide');
							},
						},
						{
							key: 'resetPos',
							value: function () {
								...
								this.pos
									...
									: (this.pos = { isStart: !1, x: 0, y: 0, volume: 0, rate: 1, light: 0, width: 0, height: 0, scopeL: 0, scopeR: 0, scopeM1: 0, scopeM2: 0, scope: -1, time: 0 });
							},
						},
						{
							key: 'changeAction',
						...
						},
						{
							...
							value: function (e, t, i, n, o) {
								...
								return Math.abs(i) > 0 && a >= 1.73 && e > o.scopeM1 && e < o.scopeM2 ? (s = 0) : (0 === Math.abs(i) || a <= 0.57) && (s = e < o.scopeL ? 1 : e > o.scopeR ? 2 : 3), s;
							},
						},
						{
							key: 'executeMove',
						...
						},
						{
							...
							value: function (e) {
								var t = this.player,
									i = this.config,
									n = this.playerConfig;
								t.state < yt ? n.closeVideoClick || (this.sendUseAction(x.createEvent('click')), t.play()) : !i.closedbClick || n.closeVideoClick ? (t.isActive ? t.blur() : t.focus()) : n.closeVideoClick || ((t.isActive || i.focusVideoClick) && (this.sendUseAction(x.createEvent('click')), this.switchPlayPause()), t.focus());
							},
						},
						{
							key: 'dbClickHandler',
							value: function (e) {
								var t = this.config,
									i = this.player;
								!t.closedbClick && i.state >= yt && (this.sendUseAction(x.createEvent('dblclick')), this.switchPlayPause());
							},
						},
						{
							key: 'onClick',
						...
						},
						{
							...
							value: function (e) {
								var t = this.pos,
									i = this.config,
									n = this.player;
								i.disablePress || ((t.rate = this.player.playbackRate), this.emitUserAction('press', 'change_rate', { prop: 'playbackRate', from: n.playbackRate, to: i.pressRate }), (n.playbackRate = i.pressRate), this.changeAction(Ti));
							},
						},
						{
							key: 'onPressEnd',
							value: function (e) {
								var t = this.pos,
									i = this.config,
									n = this.player;
								i.disablePress || (this.emitUserAction('pressend', 'change_rate', { prop: 'playbackRate', from: n.playbackRate, to: t.rate }), (n.playbackRate = t.rate), (t.rate = 1), this.changeAction(_i));
							},
						},
						{
							key: 'updateTime',
							value: function (e) {
								...
								(o = (o += this.pos.time) < 0 ? 0 : o > 1e3 * n ? 1e3 * n - 200 : o), t.getPlugin('time') && t.getPlugin('time').updateTime(o / 1e3), t.getPlugin('progress') && t.getPlugin('progress').updatePercent(o / 1e3 / this.duration, !0), this.activeSeekNote(o / 1e3, e > 0), i.isTouchingSeek && t.seek(Number((o - this.timeOffset) / 1e3).toFixed(1)), (this.pos.time = o);
							},
						},
						{
							key: 'updateVolume',
						...
						},
						{
							...
							value: function (e) {
								...
								var t = this.pos,
									...
									n = this.xgMask,
									o = t.light + 0.8 * e;
								(o = o > i.maxDarkness ? i.maxDarkness : o < 0 ? 0 : o), n && (n.style.backgroundColor = 'rgba(0,0,0,'.concat(o, ')')), (t.light = o);
							},
						},
						{
							key: 'activeSeekNote',
							value: function (e) {
								...
								if (e && 'number' == typeof e && !o && !n.disableActive) {
									e < 0 ? (e = 0) : e > i.duration && (e = i.duration - 0.2), this.changeAction(wi);
									var r = i.plugins.start;
									r && r.focusHide(), (this.find('.xg-dur').innerHTML = x.format(this.duration)), (this.find('.xg-cur').innerHTML = x.format(e)), (this.find('.xg-curbar').style.width = ''.concat((e / this.duration) * 100, '%')), t ? x.removeClass(this.find('.xg-seek-show'), 'xg-back') : x.addClass(this.find('.xg-seek-show'), 'xg-back'), this.updateThumbnails(e);
								}
							},
						},
						{
						...
						},
						{
							...
							value: function () {
								var e = this.player;
								this.timer && clearTimeout(this.timer), (this.thumbnail = null), e.root.removeChild(this.xgMask), (this.xgMask = null), this.touch && this.touch.destroy(), (this.touch = null), e.root.removeEventListener('touchmove', this.onRootTouchMove, !0), e.root.removeEventListener('touchend', this.onRootTouchEnd, !0);
							},
						},
						{
							key: 'render',
							value: function () {
								...
								return '\n     <xg-trigger class="trigger">\n     <div class="'
									...
									.concat(this.config.disableSeekIcon ? ' hide-seek-icon' : '', '">\n              <i class="xg-seek-icon"></i>\n              <span class="xg-cur">00:00</span>\n              <span>/</span>\n              <span class="xg-dur">00:00</span>\n            </div>\n              <div class="xg-bar xg-timebar">\n                <div class="xg-curbar"></div>\n              </div>\n        </div>\n        <div class="xg-playbackrate xg-top-note">\n            <span><i>')
					...
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return { index: 0, disableGesture: !1, gestureX: !0, gestureY: !0, gradient: 'normal', isTouchingSeek: !1, miniMoveStep: 5, miniYPer: 5, scopeL: 0.25, scopeR: 0.25, scopeM: 0.9, pressRate: 2, darkness: !0, maxDarkness: 0.8, disableActive: !1, disableTimeProgress: !1, hideControlsActive: !1, hideControlsEnd: !1, moveDuration: 36e4, closedbClick: !1, disablePress: !0, disableSeekIcon: !1, focusVideoClick: !1 };
							},
						},
					]
				),
			...
			return (
				s(u((e = i.call.apply(i, [this].concat(r)))), 'onBodyKeyDown', function (t) {
					if (e.player) {
						...
						l || c || (!s.isUserActive && !h) || Ei(i.target) || !e.checkIsVisible() || i.metaKey || i.altKey || i.ctrlKey ? (r.isBodyKeyDown = !1) : (t.repeat || r.isKeyDown || ((i.target === document.body || (e.config.isGlobalTrigger && !Ei(i.target))) && e.checkCode(n, !0) && (r.isBodyKeyDown = !0), document.addEventListener('keyup', e.onBodyKeyUp)), r.isBodyKeyDown && e.handleKeyDown(i));
					}
				}),
				s(u(e), 'onBodyKeyUp', function (t) {
					e.player && (document.removeEventListener('keyup', e.onBodyKeyUp), e.handleKeyUp(t));
				}),
				s(u(e), 'onKeydown', function (t) {
					if (e.player) {
						var i = t || window.event,
							n = u(e)._keyState;
						if (!i.repeat) {
							if (e.config.disable || e.config.disableRootTrigger || i.metaKey || i.altKey || i.ctrlKey) return;
							if (!e.player.isUserActive && !e.config.isIgnoreUserActive) return;
							!i || (37 !== i.keyCode && !e.checkCode(i.keyCode)) || (i.target !== e.player.root && i.target !== e.player.video && i.target !== e.player.controls.el) || (n.isKeyDown = !0), e.player.root.addEventListener('keyup', e.onKeyup);
						}
						n.isKeyDown && e.handleKeyDown(i);
					}
				}),
				s(u(e), 'onKeyup', function (t) {
					e.player && (e.player.root.removeEventListener('keyup', e.onKeyup), e.handleKeyUp(t));
				}),
				e
			);
		}
			...
			r(
				...
				[
					{
						...
						value: function () {
							...
							t &&
								Object.keys(t).map(function (i) {
									e.keyCodeMap[i]
										? ['keyCode', 'action', 'disable', 'pressAction', 'disablePress', 'isBodyTarget'].map(function (n) {
					...
					},
					{
						...
						value: function () {
							...
							e && 'number' == typeof e && (this.seekStep = e), (this.keyCodeMap = { space: { keyCode: 32, action: 'playPause', disable: !1, disablePress: !1, noBodyTarget: !1 }, up: { keyCode: 38, action: 'upVolume', disable: !1, disablePress: !1, noBodyTarget: !0 }, down: { keyCode: 40, action: 'downVolume', disable: !1, disablePress: !1, noBodyTarget: !0 }, left: { keyCode: 37, action: 'seekBack', disablePress: !1, disable: !1 }, right: { keyCode: 39, action: 'seek', pressAction: 'changePlaybackRate', disablePress: !1, disable: !1 }, esc: { keyCode: 27, action: 'exitFullscreen', disablePress: !0, disable: !1 } }), this.mergekeyCodeMap(), (this._keyState = { isKeyDown: !1, isBodyKeyDown: !1, isPress: !1, tt: 0, playbackRate: 0 }), this.player.root.addEventListener('keydown', this.onKeydown), document.addEventListener('keydown', this.onBodyKeyDown);
						},
					},
					{
						key: 'checkIsVisible',
					...
					},
					{
						...
						value: function (e) {
							var t = this.player,
								...
								a = n > -1 ? n : i,
								l = r || o,
								c = e.repeat && this.seekStep >= 4 ? parseInt(this.seekStep / 2, 10) : this.seekStep;
							a + c <= l ? (a += c) : (a = l);
							var u = x.getCurrentTimeByOffset(a, s),
								h = { currentTime: { from: i, to: u } };
							this.emitUserAction(e, 'seek', { props: h }), (this.player.currentTime = u);
						},
					},
					{
						key: 'seekBack',
						value: function (e) {
							var t = this.player,
								...
								n = t.offsetCurrentTime,
								o = t.timeSegments,
								r = (n > -1 ? n : i) - (e.repeat ? parseInt(this.seekStep / 2, 10) : this.seekStep);
							r < 0 && (r = 0);
							var s = { currentTime: { from: i, to: (r = x.getCurrentTimeByOffset(r, o)) } };
							this.emitUserAction(e, 'seek', { props: s }), (this.player.currentTime = r);
						},
					},
					{
						...
						value: function (e) {
							var t = this._keyState,
								i = this.config,
								n = this.player;
							0 === t.playbackRate && ((t.playbackRate = n.playbackRate), (n.playbackRate = i.playbackRate));
						},
					},
					{
						key: 'playPause',
					...
					},
					{
						...
						value: function (e) {
							var t = this.player,
								i = t.fullscreen,
								n = t.cssfullscreen;
							i && (this.emitUserAction('keyup', 'switch_fullscreen', { prop: 'fullscreen', from: i, to: !i }), t.exitFullscreen()), n && (this.emitUserAction('keyup', 'switch_css_fullscreen', { prop: 'cssfullscreen', from: n, to: !n }), t.exitCssFullscreen());
						},
					},
					{
						key: 'handleKeyDown',
					...
					},
					{
						...
						value: function (e) {
							var t = this._keyState;
							t.playbackRate > 0 && ((this.player.playbackRate = t.playbackRate), (t.playbackRate = 0)), (t.isKeyDown = !1), (t.isPress = !1), (t.tt = 0);
						},
					},
					{
						key: 'handleKeyCode',
						value: function (e, i, n) {
							for (var o = Object.keys(this.keyCodeMap), r = 0; r < o.length; r++) {
								var s = this.keyCodeMap[o[r]],
									a = s.action,
									l = s.keyCode,
									c = s.disable,
									u = s.pressAction,
								...
								if (l === e) {
									if (!(c || (n && h))) {
										var d = (n && u) || a;
										'function' == typeof d ? a(i, this.player, n) : 'string' == typeof d && 'function' == typeof this[d] && this[d](i, this.player, n), this.emit(be, t({ key: o[r], target: i.target, isPress: n }, this.keyCodeMap[o[r]]));
									}
									break;
								}
							}
				...
				[
					...
					},
					{
						key: 'defaultConfig',
						get: function () {
							return { seekStep: 10, checkVisible: !1, disableBodyTrigger: !1, disableRootTrigger: !1, isGlobalTrigger: !1, keyCodeMap: {}, disable: !1, playbackRate: 2, isIgnoreUserActive: !1 };
						},
					},
				]
			),
	...
	var Ii = (function (e) {
		...
		Oi = (function () {
			function e(t) {
				n(this, e), (this.fragments = t.fragments || []), 0 === this.fragments.length && this.fragments.push({ percent: 1 }), (this._callBack = t.actionCallback), (this.fragConfig = { fragFocusClass: t.fragFocusClass || 'inner-focus-point', fragAutoFocus: !!t.fragAutoFocus, fragClass: t.fragClass || '' }), (this.style = t.style || { playedColor: '', cachedColor: '', progressColor: '' }), (this.duration = 0), (this.cachedIndex = 0), (this.playedIndex = 0), (this.focusIndex = -1);
			}
			return (
				r(e, [
					{
						...
						value: function (e) {
							...
							this.fragments = n.map(function (e) {
								return (e.start = parseInt(i, 10)), (e.end = parseInt(i + e.percent * t.duration, 10)), (e.duration = parseInt(e.percent * t.duration, 10)), (i += e.percent * t.duration), e;
							});
						},
					},
					{
						...
						value: function () {
							var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'played',
								t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { newIndex: 0, curIndex: 0, millisecond: 0 },
								i = this.progressList,
								n = this.fragments;
							if (!(i.length < 1)) {
								var o = t.newIndex,
					...
					},
					{
						...
						value: function () {
							...
							if ('Undefined' !== x.typeOf(e.played)) {
								...
								if (o < 0) return;
								this.updateProgress('played', { newIndex: o, curIndex: i, millisecond: parseInt(1e3 * e.played, 10) }), (this.playedIndex = o);
							}
							if ('Undefined' !== x.typeOf(e.cached)) {
								var r = this.findIndex(1e3 * e.cached, n);
								if (r < 0) return;
								this.updateProgress('cached', { newIndex: r, curIndex: n, millisecond: parseInt(1e3 * e.cached, 10) }), (this.cachedIndex = r);
							}
						},
					},
					{
					...
					},
					{
						key: 'findHightLight',
						value: function () {
							for (var e = this.root.children, t = 0; t < e.length; t++) if (x.hasClass(e[t], this.fragConfig.fragFocusClass)) return { dom: e[t], pos: e[t].getBoundingClientRect() };
						},
					},
					{
						key: 'findFragment',
					...
					},
					{
						key: 'unHightLight',
						value: function () {
							for (var e = this.root.children, t = 0; t < e.length; t++) x.removeClass(e[t], this.fragConfig.fragFocusClass);
						},
					},
					{
						key: 'setHightLight',
						value: function (e) {
							var t = this.root.children;
							if (e < t.length) return x.addClass(t[e], this.fragConfig.fragFocusClass), { dom: t[e], pos: t[e].getBoundingClientRect() };
						},
					},
					{
						key: 'destroy',
					...
					},
					{
						...
						value: function (e) {
							...
							if (
								...
								if (((this.fragments = 0 === e.fragments.length ? [{ percent: 1 }] : e.fragments), this.updateDuration(this.duration), (this.playedIndex = 0), (this.cachedIndex = 0), this.root)) for (var i = this.root.children; i.length > 0; ) this.root.removeChild(i[0]);
								this.render();
							}
						},
					},
						...
						value: function () {
							...
							if ((this.root || (this.root = x.createDom('xg-inners', '', {}, 'progress-list')), this.fragments)) {
								...
								this.progressList = this.fragments.map(function (i) {
									var r = x.createDom('xg-inner', '', { style: t ? 'background:'.concat(t, '; flex: ').concat(i.percent) : 'flex: '.concat(i.percent) }, ''.concat(i.isFocus ? o : '', ' xgplayer-progress-inner ').concat(n));
									return (
										e.root.appendChild(r),
										Ai.forEach(function (t) {
											r.appendChild(x.createDom(t.tag, '', { style: t.styleKey ? 'background: '.concat(e.style[t.styleKey], '; width:0;') : 'width:0;' }, t.className));
										}),
		...
		Di = { POINT: 'inner-focus-point', HIGHLIGHT: 'inner-focus-highlight' },
		Ri = (function (e) {
			a(l, e);
			var o = d(l);
			function l(e) {
				...
				return (
					...
					s(u(t), '_mouseDownHandler', function (e, i) {
						(t._state.time = i.currentTime), t.updateWidth(i.currentTime, i.seekTime, i.percent, 0), t._updateInnerFocus(i);
					}),
					s(u(t), '_mouseUpHandler', function (e, i) {
						u(t).pos.moving && t.updateWidth(i.currentTime, i.seekTime, i.percent, 2);
					}),
					s(u(t), '_mouseMoveHandler', function (e, i) {
						var n = u(t),
							...
							s = n.config,
							a = n.player;
						o.time < i.currentTime ? (i.forward = !0) : (i.forward = !1), (o.time = i.currentTime), r.isDown && !r.moving && ((r.moving = !0), s.isPauseMoving && a.pause(), t.triggerCallbacks('dragstart', i, e), t.emitUserAction('drag', 'dragstart', i)), t.updateWidth(i.currentTime, i.seekTime, i.percent, 1), t.triggerCallbacks('dragmove', i, e), t._updateInnerFocus(i);
					}),
					s(u(t), 'onMouseDown', function (e) {
						...
						if (!(o.isMini || s.closeMoveSeek || (!a.allowSeekAfterEnded && o.ended))) {
							if (o.duration || o.isPlaying) {
								e.stopPropagation(), t.focus(), x.checkIsFunction(a.disableSwipeHandler) && a.disableSwipeHandler(), x.checkIsFunction(s.onMoveStart) && s.onMoveStart(), x.event(e), (r.x = c), (r.isDown = !0), (r.moving = !1), (n.prePlayTime = o.currentTime), o.focus({ autoHide: !1 }), (t.isProgressMoving = !0), x.addClass(t.progressBtn, 'active');
								var h = t.computeTime(e, c);
								return (h.prePlayTime = n.prePlayTime), t._mouseDownHandlerHook(e, h), 'touchstart' === e.type ? (t.root.addEventListener('touchmove', t.onMouseMove), t.root.addEventListener('touchend', t.onMouseUp)) : (t.unbind('mousemove', t.onMoveOnly), document.addEventListener('mousemove', t.onMouseMove, !1), document.addEventListener('mouseup', t.onMouseUp, !1)), !0;
							}
							o.play();
						}
					}),
					s(u(t), 'onMouseUp', function (e) {
						var i = u(t),
							...
							s = i.playerConfig,
							a = i._state;
						e.stopPropagation(), e.preventDefault(), x.checkIsFunction(s.enableSwipeHandler) && s.enableSwipeHandler(), x.checkIsFunction(o.onMoveEnd) && o.onMoveEnd(), x.event(e), x.removeClass(t.progressBtn, 'active');
						var l = t.computeTime(e, r.x);
						(l.prePlayTime = a.prePlayTime),
							r.moving ? (t.triggerCallbacks('dragend', l, e), t.emitUserAction('drag', 'dragend', l)) : (t.triggerCallbacks('click', l, e), t.emitUserAction('click', 'click', l)),
				...
				r(
					...
					[
						...
						},
						{
							...
							value: function () {
								...
								if (!this.config.disable && !this.playerConfig.isLive) {
									(this.pos = { x: 0, y: 0, moving: !1, isDown: !1, isEnter: !1, isLocked: !1 }), (this.outer = this.find('xg-outer'));
									var t = this.config,
										i = t.fragFocusClass,
										n = t.fragAutoFocus,
										o = t.fragClass;
									this._initInner(this.config.fragments, { fragFocusClass: i, fragAutoFocus: n, fragClass: o, style: this.playerConfig.commonStyle || {} }),
						...
						},
						{
							...
							value: function () {
								var e = this.player,
									t = this.pos;
								(t.isEnter = !1), e.isMini || (this.unbind('mousemove', this.onMoveOnly), t.isDown ? this.unbind('mouseleave', this.onMouseLeave) : this.blur());
							},
						},
						{
							key: 'bindDomEvents',
						...
						},
						{
							...
							value: function (e, t, i, n) {
								...
								if (!o.isCloseClickSeek || 0 !== n) {
									var s = (t = t >= r.duration ? r.duration - o.endedDiff : Number(t).toFixed(1));
									this.updatePercent(i), this.updateTime(e), (1 !== n || (o.isDragingSeek && 'audio' !== r.config.mediaType)) && ((this._state.now = s), (this._state.direc = s > r.currentTime ? 0 : 1), r.seek(s));
								}
							},
						},
						{
							...
							value: function (e, t) {
								...
								return { percent: d, currentTime: f, seekTime: x.getCurrentTimeByOffset(f, o.timeSegments), offset: h, width: i, left: n, e: e };
							},
						},
						{
							key: 'updateTime',
						...
						},
						{
							...
							value: function (e, t) {
								if (((this.isProgressMoving = !0), !this.config.disable)) {
									(e = e > 1 ? 1 : e < 0 ? 0 : e), (this.progressBtn.style.left = ''.concat(100 * e, '%')), this.innerList.update({ played: e * this.offsetDuration }, this.offsetDuration);
									var i = this.player.plugins.miniprogress;
									i && i.update({ played: e * this.offsetDuration }, this.offsetDuration);
								}
							},
						},
						{
							...
							value: function (e) {
								...
								if (!t.isSeeking && !this.isProgressMoving) {
									...
									(r = x.adjustTimeByDuration(r, n, e)), this.innerList.update({ played: r }, n), (this.progressBtn.style.left = ''.concat((r / n) * 100, '%'));
					...
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return { position: it.CONTROLS_CENTER, index: 0, disable: !1, isDragingSeek: !0, closeMoveSeek: !1, isPauseMoving: !1, isCloseClickSeek: !1, fragments: [{ percent: 1 }], fragFocusClass: Di.POINT, fragClass: '', fragAutoFocus: !1, miniMoveStep: 5, miniStartStep: 2, onMoveStart: function () {}, onMoveEnd: function () {}, endedDiff: 0.2 };
							},
						},
						{
					...
					[
						...
						},
						{
							...
							value: function (e) {
								e.preventDefault(), e.stopPropagation();
								var t = this.player;
								return this.emitUserAction(e, 'switch_play_pause', { prop: 'paused', from: t.paused, to: !t.paused }), t.ended ? t.replay() : t.paused ? (t.play(), this.animate(!1)) : (t.pause(), this.animate(!0)), !1;
							},
						},
						{
							key: 'initIcons',
						...
						},
						{
							...
							value: function (e) {
								if (this.player) {
									var t = this.i18nKeys,
										i = this.find('.xg-tips');
									e ? (this.setAttr('data-state', 'pause'), i && this.changeLangTextKey(i, t.PLAY_TIPS)) : (this.setAttr('data-state', 'play'), i && this.changeLangTextKey(i, t.PAUSE_TIPS));
								}
							},
						},
						{
						...
						},
						{
							key: 'render',
							value: function () {
								if (!this.config.disable) return '<xg-icon class="xgplayer-play">\n    <div class="xgplayer-icon">\n    </div>\n    '.concat(Yt(this, 'PLAY_TIPS', this.playerConfig.isHideTips), '\n    </xg-icon>');
							},
						},
					],
					[
	...
	var Ui = (function (e) {
				...
				r(
					...
					[
								...
								if (!t.disable) {
									...
									n.fullscreenTarget === o && this.player.getFullscreen().catch(function (e) {}),
										...
										this.on(he, function (t) {
											...
											i && e.changeLangTextKey(i, t ? e.i18nKeys.EXITFULLSCREEN_TIPS : e.i18nKeys.FULLSCREEN_TIPS), e.animate(t);
										}),
						...
						},
						{
							key: 'registerIcons',
							value: function () {
								return { fullscreen: { icon: Hi, class: 'xg-get-fullscreen' }, exitFullscreen: { icon: Bi, class: 'xg-exit-fullscreen' } };
							},
						},
						{
							key: 'destroy',
							value: function () {
								p(l(i.prototype), 'destroy', this).call(this), this.unbind('.xgplayer-icon', 'mobile' === O.device ? 'touchend' : 'click', this.handleFullscreen), 'mobile' === O.device && window.removeEventListener('orientationchange', this._onOrientationChange);
							},
						},
						{
							key: 'initIcons',
						...
						},
						{
							...
							value: function (e) {
								...
								var t = this.player,
									i = this.config;
								!0 === i.useCssFullscreen || ('function' == typeof i.useCssFullscreen && i.useCssFullscreen()) ? (t.fullscreen ? t.exitCssFullscreen() : t.getCssFullscreen(), this.animate(t.fullscreen)) : i.rotateFullscreen ? (t.fullscreen ? t.exitRotateFullscreen() : t.getRotateFullscreen(), this.animate(t.fullscreen)) : i.switchCallback && 'function' == typeof i.switchCallback ? i.switchCallback(t.fullscreen) : t.fullscreen ? t.exitFullscreen() : t.getFullscreen().catch(function (e) {});
							},
						},
						{
							key: 'animate',
					...
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return { position: it.CONTROLS_RIGHT, index: 0, useCssFullscreen: !1, rotateFullscreen: !1, switchCallback: null, target: null, disable: !1, needBackIcon: !1 };
							},
						},
					]
				),
				...
				r(
					...
					[
						...
						},
						{
							...
							value: function () {
								...
								(this.mode = 'flex' === t ? 'flex' : 'normal'),
									this.config.disable ||
										('flex' === this.mode && (this.createCenterTime(), (this.root.style.display = 'none')),
										(this.durationDom = this.find('.time-duration')),
										(this.timeDom = this.find('.time-current')),
										this.on([q, G, W], function () {
											e.onTimeUpdate();
										}),
										this.on(H, function () {
											e.onTimeUpdate(!0);
						...
						},
						{
							key: 'show',
							value: function () {
								if ('flex' === this.mode) return this.centerCurDom && (this.centerCurDom.style.display = 'block'), void (this.centerDurDom && (this.centerDurDom.style.display = 'block'));
						...
						},
						{
							key: 'hide',
							value: function () {
								if ('flex' === this.mode) return this.centerCurDom && (this.centerCurDom.style.display = 'none'), void (this.centerDurDom && (this.centerDurDom.style.display = 'none'));
								this.root.style.display = 'none';
							},
						},
						{
							...
							value: function (e) {
								...
								if (!i.disable && !this.isActiving && t.hasStart) {
									...
									(o = x.adjustTimeByDuration(o, n, e)), 'flex' === this.mode ? ((this.centerCurDom.innerHTML = this.minWidthTime(x.format(o))), n !== 1 / 0 && n > 0 && (this.centerDurDom.innerHTML = x.format(n))) : ((this.timeDom.innerHTML = this.minWidthTime(x.format(o))), n !== 1 / 0 && n > 0 && (this.durationDom.innerHTML = x.format(n)));
								}
							},
						},
						{
							key: 'onReset',
							value: function () {
								'flex' === this.mode ? ((this.centerCurDom.innerHTML = this.minWidthTime(x.format(0))), (this.centerDurDom.innerHTML = x.format(0))) : ((this.timeDom.innerHTML = this.minWidthTime(x.format(0))), (this.durationDom.innerHTML = x.format(0)));
							},
						},
						{
							...
							value: function () {
								...
								if (e.controls && e.controls.center) {
									...
									(this.centerCurDom = x.createDom('xg-icon', '00:00', {}, 'xgplayer-time xg-time-left')), (this.centerDurDom = x.createDom('xg-icon', '00:00', {}, 'xgplayer-time xg-time-right')), t.children.length > 0 ? t.insertBefore(this.centerCurDom, t.children[0]) : t.appendChild(this.centerCurDom), t.appendChild(this.centerDurDom);
								}
							},
						},
						{
							...
							value: function () {
								var e = this.config;
								this.duration === 1 / 0 || this.playerConfig.isLive ? (x.hide(this.durationDom), x.hide(this.timeDom), x.hide(this.find('.time-separator')), x.show(this.find('.time-live-tag'))) : x.hide(this.find('.time-live-tag')), e.hide ? this.hide() : this.show();
							},
						},
						{
							key: 'changeLiveState',
							value: function (e) {
								e ? (x.hide(this.durationDom), x.hide(this.timeDom), x.hide(this.find('.time-separator')), x.show(this.find('.time-live-tag'))) : (x.hide(this.find('.time-live-tag')), x.show(this.find('.time-separator')), x.show(this.durationDom), x.show(this.timeDom));
							},
						},
						{
							key: 'updateTime',
							value: function (e) {
								(this.isActiving = !0), (!e && 0 !== e) || e > this.duration || ('flex' !== this.mode ? (this.timeDom.innerHTML = this.minWidthTime(x.format(e))) : (this.centerCurDom.innerHTML = this.minWidthTime(x.format(e))));
							},
						},
						{
							key: 'minWidthTime',
						...
						},
						{
							...
							value: function () {
								...
								this.off(G, i), t.isSeeking ? this.once(G, i) : (this.isActiving = !1);
							},
						},
						{
							key: 'destroy',
						...
						},
						{
							key: 'render',
							value: function () {
								if (!this.config.disable) return '<xg-icon class="xgplayer-time">\n    <span class="time-current">00:00</span>\n    <span class="time-separator">/</span>\n    <span class="time-duration">00:00</span>\n    <span class="time-live-tag">'.concat(this.i18n.LIVE_TIP, '</span>\n    </xg-icon>');
							},
						},
					],
					[
		...
		Gi = (function (e) {
			...
			function i() {
				...
				for (var o = arguments.length, r = new Array(o), a = 0; a < o; a++) r[a] = arguments[a];
				return (
					s(u((e = t.call.apply(t, [this].concat(r)))), '_onDurationChange', function () {
						e.updateSegments();
						var t = e.player,
							i = t.currentTime,
							n = t.timeSegments;
					...
					s(u(e), '_onLoadedData', function () {
						...
						if (e._checkIfEnabled(t)) {
							...
							(e.player.offsetCurrentTime = i), e.changeIndex(0, t), e.curPos.start > 0 && (e.player.currentTime = e.curPos.start);
						}
					}),
						...
						if (e._checkIfEnabled(n)) {
							...
							if (((e.player.offsetCurrentTime = s), e.curPos)) {
								var a = e.curPos,
									l = a.start,
									c = a.end;
								i < l ? (e.player.currentTime = l) : i > c && r >= o - 1 && e.player.pause();
							}
						}
					}),
					s(u(e), '_onSeeking', function () {
						...
						if (e._checkIfEnabled(n))
							...
							else if (i > n[n.length - 1].end) e.player.currentTime = n[n.length - 1].end;
							else {
								var o = x.getIndexByTime(i, n);
								if (o >= 0) {
					...
					s(u(e), '_onPlay', function () {
						var t = e.player,
							i = t.currentTime,
							n = t.timeSegments;
						e._checkIfEnabled(n) && i >= n[n.length - 1].end && (e.player.currentTime = n[0].start);
					}),
					e
				);
			}
					...
					[
						{
							key: 'afterCreate',
							value: function () {
								(this.curIndex = -1), (this.curPos = null), (this.lastCurrentTime = 0), this.updateSegments(), this.on(q, this._onDurationChange), this.on(X, this._onLoadedData), this.on(W, this._onTimeupdate), this.on(V, this._onSeeking), this.on(N, this._onPlay);
							},
						},
						{
							key: 'setConfig',
						...
						},
						{
							...
							value: function () {
								var e = this.config,
									...
									i = e.segments,
									n = this.player;
								if (t || !i || 0 === i.length) (n.timeSegments = []), (n.offsetDuration = 0), (n.offsetCurrentTime = -1);
								else {
									var o = this.formatTimeSegments(i, n.duration);
									(n.timeSegments = o), (n.offsetDuration = o.length > 0 ? o[o.length - 1].duration : 0);
								}
							},
						},
						{
								...
								return e
									? (e.sort(function (e, t) {
									  ...
									  e.forEach(function (e, n) {
											var o = {};
											if (((o.start = e.start < 0 ? 0 : e.start), (o.end = t > 0 && e.end > t ? t : e.end), !(t > 0 && o.start > t))) {
												i.push(o);
												var r = o.end - o.start;
												if (0 === n) (o.offset = e.start), (o.cTime = 0), (o.segDuration = r), (o.duration = r);
												else {
													var s = i[n - 1];
													(o.offset = s.offset + (o.start - s.end)), (o.cTime = s.duration + s.cTime), (o.segDuration = r), (o.duration = s.duration + r);
												}
											}
									  }),
									  i)
						...
						},
						{
							key: 'changeIndex',
							value: function (e, t) {
								(this.curIndex = e), e >= 0 && t.length > 0 ? (this.curPos = t[e]) : (this.curPos = null);
							},
						},
					],
					[
		...
		function i() {
			...
			return (
				s(u((e = t.call.apply(t, [this].concat(r)))), 'onBarMousedown', function (t) {
					...
					if (((r.h = s), (r.barH = o.height), (e.pos = r), !(s < -2))) return e.updateVolumePos(s, t), document.addEventListener('mouseup', e.onBarMouseUp), (e._d.isStart = !0), !1;
				}),
				...
				s(u(e), 'onVolumeChange', function (t) {
					if (e.player) {
						var i = e.player,
							n = i.muted,
							o = i.volume;
						e._d.isMoving || ((e.find('.xgplayer-drag').style.height = n || 0 === o ? '4px' : ''.concat(100 * o, '%')), e.config.showValueLabel && e.updateVolumeValue()), e.animate(n, o);
					}
				}),
				e
			);
			...
			r(
				...
				[
					{
						key: 'registerIcons',
						value: function () {
							return { volumeSmall: { icon: zi, class: 'xg-volume-small' }, volumeLarge: { icon: Wi, class: 'xg-volume' }, volumeMuted: { icon: Ki, class: 'xg-volume-mute' } };
						},
					},
					{
						key: 'afterCreate',
						value: function () {
							var e = this;
							if (((this._timerId = null), (this._d = { isStart: !1, isMoving: !1, isActive: !1 }), !this.config.disable)) {
								this.initIcons();
								var t = this.playerConfig,
									i = t.commonStyle,
									n = t.volume;
								i.volumeColor && (this.find('.xgplayer-drag').style.backgroundColor = i.volumeColor),
									...
									'mobile' !== O.device && 'mobile' !== this.playerConfig.isMobileSimulateMode && (this.bind('mouseenter', this._onMouseenterHandler), this.bind(['blur', 'mouseleave'], this._onMouseleaveHandler), this.bind('.xgplayer-slider', 'mousedown', this.onBarMousedown), this.bind('.xgplayer-slider', 'mousemove', this.onBarMouseMove), this.bind('.xgplayer-slider', 'mouseup', this.onBarMouseUp)),
					...
					},
					{
						...
						value: function (e, t) {
							...
							if (o && n) {
								...
								i.muted && (a.muted = { from: !0, to: !1 }), this.emitUserAction(t, 'change_volume', { muted: i.muted, volume: i.volume, props: a }), (i.volume = Math.max(Math.min(r / 1e3, 1), 0)), i.muted && (i.muted = !1), this.config.showValueLabel && this.updateVolumeValue();
							}
						},
					},
					{
					...
					},
					{
						key: 'focus',
						value: function () {
							this.player.focus({ autoHide: !1 }), this._timerId && (x.clearTimeout(this, this._timerId), (this._timerId = null)), x.addClass(this.root, 'slide-show');
						},
					},
					{
						key: 'unFocus',
						value: function () {
							...
							o.isActive ||
								...
								(this._timerId = x.setTimeout(
									this,
									function () {
										o.isActive || (i ? r.blur() : r.focus(), x.removeClass(e.root, 'slide-show'), o.isStart && e.onBarMouseUp(n)), (e._timerId = null);
									},
									t
								)));
						},
					},
					{
						...
						value: function (e) {
							e && e.stopPropagation();
							var t = this.player;
							this._d.isStart && this.onBarMouseUp(e), this.emitUserAction(e, 'change_muted', { muted: t.muted, volume: t.volume, props: { muted: { from: t.muted, to: !t.muted } } }), t.volume > 0 && (t.muted = !t.muted), t.volume < 0.01 && (t.volume = this.config.miniVolume);
						},
					},
					{
						key: 'animate',
						value: function (e, t) {
							e || 0 === t ? this.setAttr('data-state', 'mute') : t < 0.5 && this.icons.volumeSmall ? this.setAttr('data-state', 'small') : this.setAttr('data-state', 'normal');
						},
					},
					{
						key: 'initIcons',
						value: function () {
							var e = this.icons;
							this.appendChild('.xgplayer-icon', e.volumeSmall), this.appendChild('.xgplayer-icon', e.volumeLarge), this.appendChild('.xgplayer-icon', e.volumeMuted);
						},
					},
					{
						key: 'destroy',
						value: function () {
							this._timerId && (x.clearTimeout(this, this._timerId), (this._timerId = null)), this.unbind('mouseenter', this.onMouseenter), this.unbind(['blur', 'mouseleave'], this.onMouseleave), this.unbind('.xgplayer-slider', 'mousedown', this.onBarMousedown), this.unbind('.xgplayer-slider', 'mousemove', this.onBarMouseMove), this.unbind('.xgplayer-slider', 'mouseup', this.onBarMouseUp), document.removeEventListener('mouseup', this.onBarMouseUp), this.unbind('.xgplayer-icon', 'mobile' === O.device ? 'touchend' : 'click', this.changeMutedHandler);
						},
					},
					{
						key: 'render',
				...
				[
					...
					},
					{
						key: 'defaultConfig',
						get: function () {
							return { position: it.CONTROLS_RIGHT, index: 1, disable: !1, showValueLabel: !1, default: 0.6, miniVolume: 0.2 };
						},
					},
				]
			),
			...
			r(
				...
				[
					{
						...
						value: function () {
							...
							if (!this.config.disable) {
								...
								(this.rootWidth = t.style.width || t.offsetWidth || t.clientWidth), (this.rootHeight = t.style.height || t.offsetHeight || t.clientHeight), this.rotateDeg && this.updateRotateDeg(this.rotateDeg, this.config.innerRotate);
							}
						},
					},
					{
						key: 'destroy',
						value: function () {
							p(l(i.prototype), 'destroy', this).call(this), this.unbind('.xgplayer-icon', ['click', 'touchend'], this.onBtnClick);
						},
					},
					{
						key: 'onBtnClick',
						value: function (e) {
							e.preventDefault(), e.stopPropagation(), this.emitUserAction(e, 'rotate'), this.rotate(this.config.clockwise, this.config.innerRotate, 1);
						},
					},
					{
						key: 'updateRotateDeg',
						value: function (e, t) {
							if ((e || (e = 0), t)) this.player.videoRotateDeg = e;
								...
								var i = this.player,
									...
									d = 0,
									f = 0;
								(0.75 !== e && 0.25 !== e) || ((u = ''.concat(c, 'px')), (h = ''.concat(l, 'px')), (d = -(c - l) / 2), (f = -(l - c) / 2));
								var p = 'translate('.concat(d, 'px,').concat(f, 'px) rotate(').concat(e, 'turn)'),
									g = { transformOrigin: 'center center', transform: p, webKitTransform: p, height: h, width: u },
									v = t ? a : r,
					...
					},
					{
						...
						value: function () {
							...
							var o = e ? 1 : -1;
							(this.rotateDeg = (this.rotateDeg + 1 + 0.25 * o * i) % 1), this.updateRotateDeg(this.rotateDeg, t), n.emit(me, 360 * this.rotateDeg);
						},
					},
					{
						key: 'registerIcons',
				...
				[
					...
					},
					{
						key: 'defaultConfig',
						get: function () {
							return { position: it.CONTROLS_RIGHT, index: 6, innerRotate: !0, clockwise: !1, rotateDeg: 0, disable: !1 };
						},
					},
				]
			),
			...
			function i() {
				...
				return (
					s(u((e = t.call.apply(t, [this].concat(r)))), 'switchPIP', function (t) {
						...
						t.stopPropagation && t.stopPropagation(), e.isPip ? (e.exitPIP(), e.emitUserAction(t, 'change_pip', { props: 'pip', from: !0, to: !1 }), e.setAttr('data-state', 'normal')) : 4 === e.player.media.readyState && (e.requestPIP(), e.emitUserAction(t, 'change_pip', { props: 'pip', from: !1, to: !0 }), e.setAttr('data-state', 'pip'));
					}),
					e
				);
			}
					...
					[
							...
							value: function () {
								...
								this.isPIPAvailable() &&
									...
									this.once(se, function () {
										e.config.showIcon && (x.removeClass(e.find('.xgplayer-icon'), 'xg-icon-disable'), e.bind('click', e.switchPIP));
									}));
							},
						},
						{
							key: 'registerIcons',
							value: function () {
								return { pipIcon: { icon: Zi, class: 'xg-get-pip' }, pipIconExit: { icon: Ji, class: 'xg-exit-pip' } };
							},
						},
						{
							key: 'initIcons',
							...
							value: function () {
								...
								(this.leavePIPCallback = function () {
									...
									(this.enterPIPCallback = function (i) {
										t.emit(ye, !0), (e.pipWindow = i.pictureInPictureWindow), e.setAttr('data-state', 'pip');
									}),
									(this.onWebkitpresentationmodechanged = function (i) {
										var n = t.media.webkitPresentationMode;
										e.pMode === en && n !== en && t.onFullscreenChange(null, !1), (e.pMode = n), n === $i ? e.enterPIPCallback(i) : n === Qi && e.leavePIPCallback(i);
									}),
									t.media && (t.media.addEventListener('enterpictureinpicture', this.enterPIPCallback), t.media.addEventListener('leavepictureinpicture', this.leavePIPCallback), i.checkWebkitSetPresentationMode(t.media) && t.media.addEventListener('webkitpresentationmodechanged', this.onWebkitpresentationmodechanged));
							},
						},
						{
							key: 'requestPIP',
							value: function () {
								...
								if (this.isPIPAvailable() && !this.isPip)
									try {
										var n = t.poster;
										return n && (e.media.poster = 'String' === x.typeOf(n) ? n : n.poster), i.checkWebkitSetPresentationMode(e.media) ? e.media.webkitSetPresentationMode('picture-in-picture') : e.media.requestPictureInPicture(), !0;
									} catch (o) {
						...
						},
						{
							...
							value: function () {
								var e = this.player;
								try {
									return this.isPIPAvailable() && this.isPip && (i.checkWebkitSetPresentationMode(e.media) ? e.media.webkitSetPresentationMode('inline') : document.exitPictureInPicture()), !0;
								} catch (t) {
						...
						},
						{
							...
							get: function () {
								var e = this.player;
								return (document.pictureInPictureElement && document.pictureInPictureElement === e.media) || e.media.webkitPresentationMode === $i;
							},
						},
						{
							key: 'isPIPAvailable',
						...
						},
						{
							key: 'render',
							value: function () {
								if (this.config.showIcon && this.isPIPAvailable()) return '<xg-icon class="xgplayer-pip">\n      <div class="xgplayer-icon xg-icon-disable">\n      </div>\n      '.concat(Yt(this, 'PIP', this.playerConfig.isHideTips), '\n    </xg-icon>');
							},
						},
					],
					[
			...
			function i(e) {
				...
				return (
					...
					s(u((o = t.call(this, e))), 'playNext', function (e) {
						var t = u(o).player;
						e.preventDefault(), e.stopPropagation(), o.idx + 1 < o.config.urlList.length ? (o.idx++, o.nextHandler(o.config.urlList[o.idx], o.idx), t.emit(Ce, o.idx + 1)) : (o.nextHandler(), t.emit(Ce));
					}),
					(o.idx = -1),
					o
				);
				...
				r(
					...
					[
						{
							key: 'afterCreate',
							value: function () {
								this.config.urlList && 0 !== this.config.urlList.length && (this.appendChild('.xgplayer-icon', this.icons.playNext), this.initEvents());
							},
						},
						{
							key: 'registerIcons',
						...
						},
						{
							...
							value: function (e) {
								var t = this.player;
								e && (t.pause(), (t.currentTime = 0), t.switchURL ? t.switchURL(e) : (t.src = e), (t.config.url = e), t.play());
							},
						},
						{
							key: 'destroy',
					...
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return { position: it.CONTROLS_LEFT, index: 1, url: null, urlList: [] };
							},
						},
					]
				),
	...
	rn.exports = function e(t, i, n) {
		var o,
			...
			p = i || 'download';
		if (((f = f.call ? f.bind(s) : Blob), 'true' === String(this) && ((l = (c = [c, l])[0]), (c = c[1])), u && u.length < 2048 && ((p = u.split('/').pop().split('?')[0]), (h.href = u), -1 !== h.href.indexOf(u)))) {
		...
		if (/^data:([\w+-]+\/[\w+.-]+)?[,;]/.test(c)) {
			if (!(c.length > 2096103.424 && f !== d)) return navigator.msSaveBlob ? navigator.msSaveBlob(k(c), p) : C(c);
			l = (c = k(c)).type || a;
		...
		function k(e) {
			for (var t = e.split(/[:;,]/), i = t[1], n = ('base64' == t[2] ? atob : decodeURIComponent)(t.pop()), o = n.length, r = 0, s = new Uint8Array(o); r < o; ++r) s[r] = n.charCodeAt(r);
		...
		if (s.URL) C(s.URL.createObjectURL(o), !0);
		else {
			if ('string' == typeof o || o.constructor === d)
				try {
					return C('data:' + l + ';base64,' + s.btoa(o));
				} catch (b) {
					return C('data:' + l + ',' + encodeURIComponent(o));
				}
	...
	var ln = (function (e) {
					...
					s(u((o = t.call(this, e))), 'download', function (e) {
						if (!o.isLock) {
							...
							var t = o.playerConfig.url,
								i = '';
							'String' === x.typeOf(t) ? (i = t) : 'Array' === x.typeOf(t) && t.length > 0 && (i = t[0].src);
				...
				r(
					...
					[
						...
						},
						{
							key: 'destroy',
							value: function () {
								p(l(i.prototype), 'destroy', this).call(this), this.unbind(['click', 'touchend'], this.download), window.clearTimeout(this.timer), (this.timer = null);
							},
						},
						{
							key: 'render',
							value: function () {
								if (!this.config.disable) return '<xg-icon class="xgplayer-download">\n   <div class="xgplayer-icon">\n   </div>\n   '.concat(Yt(this, 'DOWNLOAD_TIPS', this.playerConfig.isHideTips), '\n    </xg-icon>');
							},
						},
					],
					[
				...
				r(
					...
					[
						...
						},
						{
							key: 'afterCreate',
							value: function () {
								p(l(i.prototype), 'afterCreate', this).call(this), this.appendChild('.xgplayer-icon', this.icons.screenshotIcon);
								var e = this.config;
						...
						},
						{
							...
							value: function (e, t) {
								var i = document.createElement('canvas'),
									n = i.getContext('2d');
								(this.canvasCtx = n), (this.canvas = i), (i.width = e || this.config.width), (i.height = t || this.config.height), (n.imageSmoothingEnabled = !0), n.imageSmoothingEnabled && (n.imageSmoothingQuality = 'high');
							},
						},
						{
							key: 'onClickBtn',
							value: function (e) {
								...
								e.preventDefault(),
									...
									this.shot().then(function (e) {
										t.emit(ke, e), t.saveScreenShot(e, t.config.name + t.config.format);
									});
							},
						},
						{
							...
							value: function (e, t) {
								var i = this,
									n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : { quality: 0.92, type: 'image/png' },
									o = this.config,
									r = this.player,
								...
								return new Promise(function (n, l) {
									...
									if (r.media.canvas) u = r.media.canvas;
										...
										i.canvas ? ((i.canvas.width = e || o.width), (i.canvas.height = t || o.height)) : i.createCanvas(e, t), (u = i.canvas), (c = i.canvasCtx);
										var h,
											d,
											f,
											p,
										...
										g > v ? ((f = u.width), (p = u.width / g), (h = 0), (d = Math.round((u.height - p) / 2))) : g === v ? ((f = u.width), (p = u.height), (h = 0), (d = 0)) : g < v && ((f = u.height * g), (p = u.height), (h = Math.round((u.width - f) / 2)), (d = 0)), c.drawImage(r.media, 0, 0, y, m, h, d, f, p);
									}
									var k = u.toDataURL(a, s).replace(a, 'image/octet-stream');
									n((k = k.replace(/^data:image\/[^;]+/, 'data:application/octet-stream')));
								});
							},
						},
						{
						...
						},
						{
							key: 'destroy',
							value: function () {
								p(l(i.prototype), 'destroy', this).call(this), this.unbind(['click', 'touchend'], this.onClickBtn), this.off(ve, this.initSize);
							},
						},
						{
							key: 'render',
					...
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return { position: it.CONTROLS_RIGHT, index: 5, quality: 0.92, type: 'image/png', format: '.png', width: 600, height: 337, fitVideo: !0, disable: !1, name: 'screenshot' };
							},
						},
					]
				),
		...
		un = (function () {
			function e(t) {
				n(this, e), (this.config = t.config), (this.parent = t.root), (this.root = x.createDom('ul', '', {}, 'xg-options-list xg-list-slide-scroll '.concat(this.config.className))), t.root.appendChild(this.root);
				var i = this.config.maxHeight;
				i && this.setStyle({ maxHeight: i }), (this.onItemClick = this.onItemClick.bind(this)), this.renderItemList();
				var o = 'mobile' === O.device ? 'touchend' : 'click';
				this._delegates = st.delegate.call(this, this.root, 'li', o, this.onItemClick);
			}
			return (
				r(e, [
					{
						...
						value: function (e) {
							...
							e ? (i.data = e) : (e = i.data),
								...
								e.map(function (e, i) {
									...
									(e['data-index'] = i), t.root.appendChild(x.createDom('li', '<span>'.concat(e.showText, '</span>'), e, n));
								});
						},
					},
					{
						...
						value: function (e) {
							...
							x.addClass(t, 'selected'), n && x.removeClass(n, 'selected'), i(e, { from: n ? this.getAttrObj(n, this.attrKeys) : null, to: this.getAttrObj(t, this.attrKeys) });
						},
					},
					{
						key: 'getAttrObj',
			...
			function o(e) {
				...
				return (
					...
					s(u((i = t.call(this, e))), 'onEnter', function (e) {
						e.stopPropagation(), i.emit('icon_mouseenter', { pluginName: i.pluginName }), i.switchActiveState(e);
					}),
					s(u(i), 'switchActiveState', function (e) {
						e.stopPropagation(), i.config.toggleMode === fn ? i.toggle(!i.isActive) : i.toggle(!0);
					}),
					s(u(i), 'onLeave', function (e) {
						e.stopPropagation(), i.emit('icon_mouseleave', { pluginName: i.pluginName }), i.config.listType !== hn && i.isActive && i.toggle(!1);
					}),
					...
					[
						...
						},
						{
							...
							value: function () {
								...
								this.initIcons(),
									...
									gn ? ((t.toggleMode = fn), (this.activeEvent = 'touchend')) : (this.activeEvent = t.toggleMode === fn ? 'click' : 'mouseenter'),
									t.toggleMode === fn ? this.bind(this.activeEvent, this.switchActiveState) : (this.bind(this.activeEvent, this.onEnter), this.bind('mouseleave', this.onLeave)),
						...
						},
						{
							...
							value: function () {
								...
								i.length > 0 &&
									...
									(this.isIcons = n)),
									n || (this.appendChild('.xgplayer-icon', x.createDom('span', '', {}, 'icon-text')), x.addClass(this.find('.xgplayer-icon'), 'btn-text'));
							},
						},
						{
							key: 'show',
						...
						},
						{
							...
							value: function (e, t, n) {
								...
								!n && (n = this.player.lang), (t = !t || x.isUndefined(e[t]) ? 'text' : t), 'number' == typeof e && (e = o[e]);
								try {
						...
						},
						{
							...
							value: function (e) {
								if (e !== this.isActive) {
									...
									e ? (i === hn ? t.blur() : t.focus(), this.optionsList && this.optionsList.show()) : (i === hn ? t.focus() : t.focusAwhile(), this.optionsList && this.optionsList.hide()), (this.isActive = e);
								}
							},
						},
						{
							...
							value: function (e, t) {
								...
								var i = this.config,
									n = i.listType,
									o = i.list;
								(this.curIndex = t.to.index), (this.curItem = o[this.curIndex]), this.changeCurrentText(), (this.config.isItemClickHide || gn || n === hn) && this.toggle(!1);
							},
						},
						...
						},
						{
							...
							value: function (e, t) {
								var i = this,
									...
									o = this.optionsList,
									r = this.player;
								if (('number' == typeof t && ((this.curIndex = t), (this.curItem = n.list[t])), o)) return o.renderItemList(e), void this.changeCurrentText();
								var s,
									a,
									l = {
										config: {
											data: e || [],
											className: ((s = n.listType), (a = n.position), s === hn ? (a === it.CONTROLS_LEFT ? 'xg-side-list xg-left-side' : 'xg-side-list xg-right-side') : ''),
											onItemClick: function (e, t) {
												i.onItemClick(e, t);
											},
										},
										root: n.listType === hn ? r.innerContainer || r.root : this.root,
									};
								if (this.config.isShowIcon) {
									var c = this.player.root.getBoundingClientRect().height,
										u = n.listType === dn ? c - 50 : c;
									u && (l.config.maxHeight = ''.concat(u, 'px')), (this.optionsList = new un(l)), this.changeCurrentText(), this.show();
								}
								this._resizeList();
							},
						},
						{
							...
							value: function () {
								...
								this.optionsList && this.optionsList.setStyle({ maxHeight: ''.concat(t, 'px') });
							},
						},
						{
							key: 'destroy',
							value: function () {
								this.config.toggleMode === fn ? this.unbind(this.activeEvent, this.switchActiveState) : (this.unbind(this.activeEvent, this.onEnter), this.unbind('mouseleave', this.onLeave)), this.isIcons && this.unbind('click', this.onIconClick), this.optionsList && (this.optionsList.destroy(), (this.optionsList = null));
							},
						},
						{
							key: 'render',
							value: function () {
								if (this.config.isShowIcon) return '<xg-icon class="xg-options-icon '.concat(this.config.className || '', '">\n    <div class="xgplayer-icon">\n    </div>\n   </xg-icon>');
							},
						},
					],
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return { position: it.CONTROLS_RIGHT, index: 100, list: [], listType: 'middle', listStyle: {}, hidePortrait: !0, isShowIcon: !1, isItemClickHide: !0, toggleMode: pn };
							},
						},
					]
				),
				...
				r(
					...
					[
						...
						},
						{
							...
							value: function (e, t) {
								...
								p(l(o.prototype), 'onItemClick', this).apply(this, arguments), this.emitUserAction(e, 'change_definition', { from: t.from, to: t.to });
								for (var n = 0; n < i.length; n++) t.to && i[n].definition === t.to.definition && (t.to.url = i[n].url), t.from && i[n].definition === t.from.definition && (t.from.url = i[n].url);
					...
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return t(t({}, vn.defaultConfig), {}, { position: it.CONTROLS_RIGHT, index: 3, list: [], defaultDefinition: '', disable: !1, hidePortrait: !1, className: 'xgplayer-definition', isShowIcon: !0 });
							},
						},
					]
				),
				...
				r(
					...
					[
							...
							value: function (e) {
								...
								Array.isArray(i) &&
									(e.config.list = i.map(function (e) {
										return 'number' == typeof e ? (e = { rate: e, text: ''.concat(e, 'x') }) : !e.text && e.rate && (e.text = ''.concat(e.rate, 'x')), e;
									}));
							},
						},
						{
						...
						},
						{
							...
							value: function (e, t) {
								...
								this.emitUserAction(e, 'change_rate', { props: r }), (this.curValue = n), (this.player.playbackRate = n);
							},
						},
						{
							key: 'renderItemList',
							...
							value: function () {
								if (!this.isIcons) {
									var e = this.config.list,
										t = e[this.curIndex < e.length ? this.curIndex : 0],
										i = '';
									(i = !t || this.curIndex < 0 ? ''.concat(this.player.playbackRate, 'x') : this.getTextByLang(t, 'iconText')), (this.find('.icon-text').innerHTML = i);
								}
							},
						},
						{
					...
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return t(t({}, vn.defaultConfig), {}, { position: it.CONTROLS_RIGHT, index: 4, list: [2, 1.5, 1, 0.75, 0.5], className: 'xgplayer-playbackrate', isShowIcon: !0, hidePortrait: !1 });
							},
						},
					]
				),
	...
	var bn = (function (e) {
					...
					[
						...
						},
						{
							...
							value: function (e) {
								...
								this.emitUserAction(e, 'switch_cssfullscreen', { cssfullscreen: t }), t ? this.player.exitCssFullscreen() : this.player.getCssFullscreen();
							},
						},
						{
							key: 'animate',
						...
						},
						{
							key: 'registerIcons',
							value: function () {
								return { cssFullscreen: { icon: kn, class: 'xg-get-cssfull' }, exitCssFullscreen: { icon: Cn, class: 'xg-exit-cssfull' } };
							},
						},
						{
							key: 'destroy',
						...
						},
						{
							key: 'render',
							value: function () {
								if (!this.config.disable) return '<xg-icon class=\'xgplayer-cssfullscreen\'>\n    <div class="xgplayer-icon">\n    </div>\n    '.concat(Yt(this, 'CSSFULLSCREEN_TIPS', this.playerConfig.isHideTips), '\n    </xg-icon>');
							},
						},
					],
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return { position: it.CONTROLS_RIGHT, index: 1, disable: !1, target: null };
							},
						},
					]
				),
				...
				r(
					...
					[
							...
							value: function () {
								...
								(this.intervalId = 0),
									...
									this.bind('.highlight', ['click', 'touchend'], function (t) {
										(e.config.onClick || e.customOnClick) && (t.preventDefault(), t.stopPropagation(), e.customOnClick ? e.customOnClick(t) : e.config.onClick(t));
									}),
						...
						},
						{
							...
							value: function (e) {
								...
								if (e) {
									...
									this.intervalId && (clearTimeout(this.intervalId), (this.intervalId = null)), x.addClass(this.root, 'show'), 'arrow' === i.mode && x.addClass(this.root, 'arrow'), (this.find('.xgplayer-prompt-detail').innerHTML = 'string' == typeof e ? e : ''.concat(e.text || '') + ''.concat(e.highlight ? '<i class="highlight">'.concat(e.highlight, '</i>') : '')), i.style && this.setStyle(i.style);
						...
						},
						{
							key: 'hide',
							value: function () {
								x.removeClass(this.root, 'show'), x.removeClass(this.root, 'arrow'), this.root.removeAttribute('style'), (this.customOnClick = null);
							},
						},
						{
							key: 'render',
							value: function () {
								return '<xg-prompt class="xgplayer-prompt '.concat(ut.CONTROLS_FOLLOW, '">\n    <span class="xgplayer-prompt-detail"></span>\n    </xg-prompt>');
							},
						},
					],
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return { interval: 3e3, style: {}, mode: 'arrow', autoHide: !0, detail: { text: '', highlight: '' }, onClick: function () {} };
							},
						},
					]
				),
		...
		Tn = { time: 0, text: '', id: 1, duration: 1, color: '#fff', style: {}, width: 6, height: 6 };
	function xn(e) {
	...
	var Sn = {
		...
		createDot: function (e) {
			...
			if (i && (t && (xn(e), this._ispots.push(e)), this.ispotsInit || !t)) {
				...
				n.isMini && (r += ' mini');
				var s = e.template ? '<div class="xgplayer-spot-pop">'.concat(e.template, '</div>') : '',
					a = x.createDom('xg-spot', s, { 'data-text': e.text, 'data-time': e.time, 'data-id': e.id }, r);
				Object.keys(o).map(function (e) {
					a.style[e] = o[e];
				}),
	...
	var En = { dragmove: 'onProgressMove', dragstart: 'onProgressDragStart', dragend: 'onProgressDragEnd', click: 'onProgressClick', mouseover: 'onProgressMouseOver', mouseenter: 'onProgressMouseOver' },
		Pn = (function (e) {
			a(i, e);
			var t = d(i);
			function i(e) {
				...
				return (
					...
					s(u((o = t.call(this, e))), 'onMousemove', function (e) {
						o.config.disable || (x.hasClass(e.target, 'xg-spot-content') && o.config.isHideThumbnailHover ? o.player.plugins.progress.onMouseLeave(e) : (o._state.f || x.hasClass(e.target, 'xg-spot-content')) && (x.event(e), e.stopPropagation()));
					}),
					s(u(o), 'onMousedown', function (e) {
						o.config.disable || ((o._state.f || x.hasClass(e.target, 'xg-spot-content')) && (x.event(e), e.stopPropagation()));
					}),
				...
				r(
					...
					[
								...
								(this._curDot = null),
									...
									(function (e) {
										...
										(e._ispots = n.map(function (e) {
											...
											(e.ispotsInit = !1),
											(e.playerSize = { left: i.sizeInfo.left, width: i.sizeInfo.width }),
											e.on(q, function () {
						...
						},
						{
							key: 'onPluginsReady',
							value: function () {
								this.player.plugins.progress && ((this.previewLine = this.find('.xg-spot-line')), (this.timePoint = this.find('.xgplayer-progress-point')), (this.timeText = this.find('.xg-spot-time')), (this.tipText = this.find('.spot-inner-text')), (this._hasThumnail = !1), this.registerThumbnail(), this.bindEvents());
							},
						},
						{
							key: 'bindEvents',
						...
						},
						{
							...
							value: function (e) {
								!this.config.disable && this.player.duration && ((this.isDrag = !0), this.videoPreview && x.addClass(this.videoPreview, 'show'));
							},
						},
						{
							key: 'onProgressDragEnd',
							value: function (e) {
								!this.config.disable && this.player.duration && ((this.isDrag = !1), this.videoPreview && x.removeClass(this.videoPreview, 'show'));
							},
						},
						{
							key: 'onProgressClick',
						...
						},
						{
							...
							value: function (e, t) {
								...
								if (a || !this._hasThumnail) {
									var l,
										c = e - (a = this._hasThumnail && a < r.width ? r.width : a) / 2;
									c < 0 && !s ? ((c = 0), (l = e - a / 2)) : c > t - a && !s ? ((l = c - (t - a)), (c = t - a)) : (l = 0), void 0 !== l && (n.style.transform = 'translateX('.concat(l.toFixed(2), 'px)')), (i.style.transform = 'translateX('.concat(c.toFixed(2), 'px) translateZ(0)'));
								}
							},
						},
						{
						...
						},
						{
							key: 'setTimeContent',
							value: function (e) {
								this.timeStr = ''.concat(x.format(e));
							},
						},
						{
							key: 'updateThumbnails',
							...
							value: function () {
								...
								if ('mobile' !== O.device) {
									...
									if ((n && n.setConfig(e), n && n.usable && i.isShowThumbnail)) {
										x.removeClass(this.root, 'short-line no-thumbnail'), 'short' === i.mode && x.addClass(this.root, 'short-line'), (this._hasThumnail = !0);
										var o = this.find('.xg-spot-thumbnail');
										(this.thumbnail = n.createThumbnail(o, 'progress-thumbnail')), i.isShowCoverPreview && ((this.videoPreview = x.createDom('xg-video-preview', '', {}, 'xgvideo-preview')), t.root.appendChild(this.videoPreview), (this.videothumbnail = n.createThumbnail(this.videoPreview, 'xgvideo-thumbnail'))), this.updateThumbnails(0);
						...
						},
						{
							...
							value: function (e, t) {
								var i = this.player.plugins.progress,
									...
									r = (n.duration / o) * 6;
								return e + t > n.duration && (t = n.duration - e), n.duration, n.duration, { left: (e / n.duration) * 100, width: (t / n.duration) * 100, isMini: t < r };
							},
						},
						{
							key: 'showDot',
						...
						},
						{
							...
							value: function (e, t) {
								var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : '';
								x.addClass(this.root, 'no-timepoint'), e && (x.addClass(this.find('.xg-spot-content'), 'show-text'), t && 'production' === this.config.mode ? (x.addClass(this.root, 'product'), (this.tipText.textContent = e)) : (x.removeClass(this.root, 'product'), (this.tipText.textContent = this._hasThumnail ? e : ''.concat(i, ' ').concat(e))));
							},
						},
						{
							key: 'hideTips',
							value: function () {
								x.removeClass(this.root, 'no-timepoint'), (this.tipText.textContent = ''), x.removeClass(this.find('.xg-spot-content'), 'show-text'), x.removeClass(this.root, 'product');
							},
						},
						{
							key: 'hide',
						...
						},
						{
							...
							value: function () {
								var e = this.config,
									t = this.playerConfig;
								(this.config.disable = !1), this.show(), !this.thumbnail && e.isShowThumbnail && this.registerThumbnail(t.thumbnail || {});
							},
						},
						{
							key: 'disable',
					...
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return { index: 1, miniWidth: 6, ispots: [], defaultText: '', isFocusDots: !0, isHideThumbnailHover: !0, isShowThumbnail: !0, isShowCoverPreview: !1, mode: '', disable: !1, width: 160, height: 90 };
							},
						},
					]
				),
				...
				r(
					...
					[
						...
						},
						{
							...
							value: function () {
								var e = this.config,
									...
									n = e.pic_num,
									o = e.interval;
								(this.ratio = (t / i) * 100), (this.interval = o || Math.round(this.player.duration / n)), (this._preloadMark = {});
							},
						},
						{
							key: 'getUrlByIndex',
						...
						},
						{
							...
							value: function (e) {
								...
								return { urlIndex: u, rowIndex: d, colIndex: f, url: y, height: g, width: p, style: { backgroundImage: 'url('.concat(y, ')'), backgroundSize: ''.concat(p * s, 'px auto'), backgroundPosition: '-'.concat(f * p, 'px -').concat(d * g, 'px'), width: ''.concat(p, 'px'), height: ''.concat(g, 'px') } };
							},
						},
						{
							key: 'update',
					...
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return { isShow: !1, urls: [], pic_num: 0, col: 0, row: 0, height: 90, width: 160, scale: 1, className: '', hidePortrait: !1 };
							},
						},
					]
				),
					...
					[
						{ key: 'afterCreate', value: function () {} },
						{
							...
							value: function () {
								var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { cached: 0, played: 0 },
									t = arguments.length > 1 ? arguments[1] : void 0;
								t && this.root && (e.cached && (this.find('xg-mini-progress-cache').style.width = ''.concat((e.cached / t) * 100, '%')), e.played && (this.find('xg-mini-progress-played').style.width = ''.concat((e.played / t) * 100, '%')));
							},
						},
						{
							key: 'render',
							value: function () {
								if (this.playerConfig.progress && this.playerConfig.miniprogress) return '<xg-mini-progress class="xg-mini-progress">\n    <xg-mini-progress-cache class="xg-mini-progress-cache"></xg-mini-progress-cache>\n    <xg-mini-progress-played class="xg-mini-progress-played"></xg-mini-progress-played>\n    </xg-mini-progress>';
							},
						},
					],
					[
			...
			function i() {
				...
				return (
					s(u((e = t.call.apply(t, [this].concat(r)))), 'onLoadedData', function (t) {
						e.player && ((e._frameCount = e.config.startFrameCount), e.renderOnTimeupdate(t), e.off(W, e.renderOnTimeupdate), e.on(W, e.renderOnTimeupdate));
					}),
					s(u(e), 'renderOnTimeupdate', function (t) {
						e._frameCount > 0 ? (e.renderOnce(), e._frameCount--) : ((e._isLoaded = !0), e.off(W, e.renderOnTimeupdate), !e.player.paused && e._checkIfCanStart() && e.start());
					}),
					s(u(e), 'start', function () {
						var t = e.player.media,
							i = Rn(),
							n = e.checkVideoIsSupport(t);
						n && e.canvasCtx && (e.stop(), t.videoWidth && t.videoHeight && ((e.videoPI = t.videoHeight > 0 ? parseInt((t.videoWidth / t.videoHeight) * 100, 10) : 0), (e.config.mode === An || i - e.preTime >= e.interval) && (t && t.videoWidth && e.update(n, e.videoPI), (e.preTime = i))), (e.frameId = x.requestAnimationFrame(e.start)));
					}),
					s(u(e), 'stop', function () {
				...
				r(
					...
					[
						{
							...
							value: function () {
								var e = this;
								!0 === this.playerConfig.dynamicBg && (this.config.disable = !1), i.isSupport || (this.config.disable = !0);
								var t = this.config,
									n = t.disable,
									o = t.mode,
									r = t.frameRate;
						...
						},
						{
							...
							value: function () {
								...
								try {
									...
									n.insertAdjacentHTML('afterbegin', '<div class="xgplayer-dynamic-bg" data-index="'.concat(t.index, '"><canvas>\n        </canvas><xgmask></xgmask></div>')), (this.root = n.children[0]), (this.canvas = this.find('canvas')), this.canvasFilter || ((this.canvas.style.filter = t.filter), (this.canvas.style.webkitFilter = t.filter)), (this.mask = this.find('xgmask')), t.addMask && (this.mask.style.background = t.maskBg), (this.canvasCtx = this.canvas.getContext('2d')), this.renderByPoster();
								} catch (o) {
						...
						},
						{
							...
							value: function () {
								...
								return this._isLoaded && e !== On && e !== Dn;
							},
						},
						{
							key: 'renderOnce',
								...
								if (this.canvas && this.canvasCtx && t)
									try {
										...
										if (r !== i.width || s !== i.height || i.pi !== t) {
											...
											var l = s,
												c = r;
											a < t ? (c = parseInt((s * t) / 100, 10)) : a > t && (l = parseInt((100 * r) / t, 10)), (i.rwidth = c * n.multiple), (i.rheight = l * n.multiple), (i.x = (r - i.rwidth) / 2), (i.y = (s - i.rheight) / 2);
										}
					...
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return { isInnerRender: !1, disable: !0, index: -1, mode: 'framerate', frameRate: 10, filter: 'blur(50px)', startFrameCount: 2, addMask: !0, multiple: 1.2, maskBg: 'rgba(0,0,0,0.7)' };
							},
						},
						{
							key: 'isSupport',
							get: function () {
								return 'boolean' == typeof Mn
									? Mn
									: (Mn = (function () {
											try {
				...
				r(
					...
					[
						...
						},
						{
							key: 'afterCreate',
							value: function () {
								this.reset(), this.on(we, this._recordUserActions), this.on(Fn.STATS_INFO, this._recordInfo), this.on(Fn.STATS_DOWNLOAD, this._downloadStats), this.on(Fn.STATS_RESET, this._onReset);
							},
						},
						{
							key: 'destroy',
						...
						},
						{
							...
							value: function (e) {
								if (e && e.startMs) {
									var i = t({ cat: 'function', dur: Date.now() - e.startMs, name: e.name || e.msg, ph: 'X', pid: 0, tid: 0, ts: e.startMs, profile: !0 }, e);
									this._info(i);
						...
						},
						{
							...
							value: function () {
								var e;
								this._stats = (s((e = {}), Nn, []), s(e, 'media', {}), e);
							},
						},
						{
							key: 'getStats',
							value: function () {
								for (var e = this.player.media, t = [], i = 0; i < e.buffered.length; i++) t.push({ start: e.buffered.start(i), end: e.buffered.end(i) });
								var n = { currentTime: e.currentTime, readyState: e.readyState, buffered: t, paused: e.paused, ended: e.ended };
								return (this._stats.media = n), { raw: this._stats, timestat: this._getTimeStats(), profile: this._getProfile() };
							},
						},
						{
							key: '_getTimeStats',
							...
							if (!n.media.paused || 0 === n.media.currentTime || !e.hasPlayed) {
								...
								if (null !== c && 0 !== c) {
									...
									if (!(h > n.media.duration)) {
										var d = h - l,
											f = d <= s;
										d < i.BROWSER_GAP_TOLERANCE || (f && (!1 !== o.useGapJump && (n.media.currentTime = e.isSafari ? h + 0.1 : h), e.player && e.player.emit('detectGap'), console.log('gapJump gapIndex', c, ' isGapSamll:', f, ' currentTime:', n.media.currentTime, ' jumpSize:', l - n.media.currentTime), 0.08 !== h && n && n.emit('log', { type: 'oneevent', end_type: 'gap', vid: n.config.vid, ext: { video_postion: Math.floor(1e3 * h) } })));
									}
								}
							}
						}
	...
	Bn.BROWSER_GAP_TOLERANCE = 0.001;
	var Un = (function (e) {
			a(i, e);
			var t = d(i);
			function i() {
				...
				return (
					...
					s(u(e), 'onJump', function () {
						var t = u(e),
							i = t.player,
							n = t.config;
						if ((clearTimeout(e.timer), (e.timer = null), !(e.jumpCnt > n.jumpCntMax || !1 === n.useWaitingTimeoutJump || (i.media.paused && 0 !== i.media.currentTime && e.hasPlayed)))) {
							(e.jumpSize = n.jumpSize * (e.jumpCnt + 1)), e.jumpCnt === n.jumpSize && e.jumpSize < 6 && (e.jumpSize = 6);
							var o = i.currentTime + e.jumpSize;
							o > i.media.duration || (console.log('waitintTimeout, currentTime:', i.currentTime, ', jumpTo:', o), e.jumpCnt++, (i.currentTime = o));
						}
					}),
					e
				);
		...
		Wn = (function (e) {
			...
			function i() {
				...
				for (var o = arguments.length, r = new Array(o), a = 0; a < o; a++) r[a] = arguments[a];
				return (
					s(u((e = t.call.apply(t, [this].concat(r)))), 'getSpeed', function () {
					...
					s(u(e), 'startTimer', function () {
						x.isMSE(e.player.video) || (e.initSpeedList(), (e.cnt = 0), (e.timer = setTimeout(e.testSpeed, e.config.testTimeStep)));
					}),
					...
					s(u(e), '_onRealSpeedChange', function (t) {
						t.speed && e.appendList(t.speed, t.type || Vn);
					}),
					...
					s(u(e), 'appendList', function (t) {
						var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Vn;
						if (e.speedListCache && e.speedListCache[i]) {
							var n = e.config.saveSpeedMax;
							e.speedListCache[i].length >= n && e.speedListCache[i].shift(), e.speedListCache[i].push(t);
							var o = u(e),
								r = o.player;
							r && (i === Vn ? (r.realTimeSpeed = t) : (r[e.getSpeedName('realTime', i)] = t)), e.updateSpeed(i);
						}
					}),
					s(u(e), 'updateSpeed', function () {
						var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Vn,
							...
							o = n.player;
						if (o)
							if (t === Vn) (o.avgSpeed && i === o.avgSpeed) || ((o.avgSpeed = i), o.emit(ue, { speed: i, realTimeSpeed: o.realTimeSpeed }));
							else {
								var r = e.getSpeedName('avg', t);
								(o[r] && i === o[r]) || ((o[r] = i), o.emit(ue, { speed: i, realTimeSpeed: o.realTimeSpeed }));
							}
					}),
					e
				);
					...
					[
						{
							...
							value: function () {
								...
								(null == i ? void 0 : i.length) > 0 && Gn.push.apply(Gn, g(i)), this.initSpeedList(), this.on('real_time_speed', this._onRealSpeedChange), (this.timer = null), (this.cnt = 0), (this.xhr = null), t && this.on([X, ae], this.startTimer);
							},
						},
						{
							key: 'getSpeedName',
						...
						},
						{
							...
							set: function (e) {
								if (((this.config.openSpeed = e), !e && this.timer)) return clearTimeout(this.timer), void (this.timer = null);
						...
						},
						{
							...
							value: function () {
								...
								this.off('real_time_speed', this._onRealSpeedChange),
									...
									Gn.forEach(function (t) {
										e.speedListCache && e.speedListCache[t] && (e.speedListCache[t] = []);
									}),
									this.speedListCache && (this.speedListCache = {}),
									clearTimeout(this.timer),
									(this.timer = null),
									this.xhr && 4 !== this.xhr.readyState && (this.xhr.cancel && this.xhr.cancel(), (this.xhr = null));
							},
						},
					],
					[
						...
						},
						{
							key: 'defaultConfig',
							get: function () {
								return { openSpeed: !1, testCnt: 3, loadSize: 204800, testTimeStep: 3e3, url: '', saveSpeedMax: 5, addSpeedTypeList: [] };
							},
						},
					]
				),
					...
					[
						{
							...
							value: function () {
								var e = this,
									t = this.player,
									i = this.config;
								((this.timer = null), (this._lastDecodedFrames = 0), (this._currentStuckCount = 0), (this._lastCheckPoint = null), (this._payload = []), i.disabled) ||
						...
						},
						{
							...
							value: function (e, t, i, n) {
								...
								if ('boolean' == typeof r && !r && !s) {
									for (var a = o.currentTime, l = o.buffered, c = !1, u = [], h = 0; h < l.length; h++) {
										var d = l.start(h),
											f = l.end(h);
									...
									4 === o.readyState && c && (this._currentStuckCount > this.config.stuckCount ? (this.emit(Le, this._payload), this._reset()) : e <= this.config.reportFrame ? (this._currentStuckCount++, this._payload.push({ bufs: u, currentTime: o.currentTime, curDecodedFrames: e, totalVideoFrames: t, droppedVideoFrames: i, checkInterval: n })) : this._reset());
								}
							},
						},
						{
	...
	xt.use({ LANG: 'zh-cn', TEXT: { ERROR_TYPES: { network: { code: 1, msg: '视频下载错误' }, mse: { code: 2, msg: '流追加错误' }, parse: { code: 3, msg: '解析错误' }, format: { code: 4, msg: '格式错误' }, decoder: { code: 5, msg: '解码错误' }, runtime: { code: 6, msg: '语法错误' }, timeout: { code: 7, msg: '播放超时' }, other: { code: 8, msg: '其他错误' } }, HAVE_NOTHING: '没有关于音频/视频是否就绪的信息', HAVE_METADATA: '音频/视频的元数据已就绪', HAVE_CURRENT_DATA: '关于当前播放位置的数据是可用的，但没有足够的数据来播放下一帧/毫秒', HAVE_FUTURE_DATA: '当前及至少下一帧的数据是可用的', HAVE_ENOUGH_DATA: '可用数据足以开始播放', NETWORK_EMPTY: '音频/视频尚未初始化', NETWORK_IDLE: '音频/视频是活动的且已选取资源，但并未使用网络', NETWORK_LOADING: '浏览器正在下载数据', NETWORK_NO_SOURCE: '未找到音频/视频来源', MEDIA_ERR_ABORTED: '取回过程被用户中止', MEDIA_ERR_NETWORK: '网络错误', MEDIA_ERR_DECODE: '解码错误', MEDIA_ERR_SRC_NOT_SUPPORTED: '不支持的音频/视频格式', REPLAY: '重播', ERROR: '网络连接似乎出现了问题', PLAY_TIPS: '播放', PAUSE_TIPS: '暂停', PLAYNEXT_TIPS: '下一集', DOWNLOAD_TIPS: '下载', ROTATE_TIPS: '旋转', RELOAD_TIPS: '重新载入', FULLSCREEN_TIPS: '进入全屏', EXITFULLSCREEN_TIPS: '退出全屏', CSSFULLSCREEN_TIPS: '进入样式全屏', EXITCSSFULLSCREEN_TIPS: '退出样式全屏', TEXTTRACK: '字幕', PIP: '画中画', SCREENSHOT: '截图', LIVE: '正在直播', OFF: '关闭', OPEN: '开启', MINI_DRAG: '点击按住可拖动视频', MINISCREEN: '小屏幕', REFRESH_TIPS: '请试试', REFRESH: '刷新', FORWARD: '快进中', LIVE_TIP: '直播' } });
	var Kn = r(function e(t, i) {
			var o, r, s;
			n(this, e);
			var a = i && 'mobile' === i.isMobileSimulateMode,
				l = i.isLive,
				c = [].concat(l ? [] : [Gi, Ri, In, Pn, Vi], [ji, Ui, Xi, on, yn, mn, ln, cn, qi, tn]),
				u = [Bt, Ut, Kt, Ii, qt, _n, wn, Ln, si];
			this.plugins = [Hn, Ft].concat(g(c), u, [Bn, Un]);
			var h = a ? 'mobile' : O.device;
			switch (h) {
				case 'pc':
					(o = this.plugins).push.apply(o, [Pi, ci, bn, Wn, zn]);
					break;
				case 'mobile':
					(r = this.plugins).push.apply(r, [Si]);
					break;
				default:
					(s = this.plugins).push.apply(s, [Pi, ci, bn]);
			}
			(O.os.isIpad || 'pc' === h) && this.plugins.push(jn), O.os.isIpad && this.plugins.push(ci), (this.ignores = []), (this.i18n = []);
		}),
		qn = (function (e) {
			a(i, e);
			var t = d(i);
	...
	return s(qn, 'defaultPreset', Kn), s(qn, 'Util', x), s(qn, 'Sniffer', O), s(qn, 'Errors', j), s(qn, 'Events', Ie), s(qn, 'Plugin', st), s(qn, 'BasePlugin', Xe), s(qn, 'I18N', xt), s(qn, 'STATE_CLASS', ut), qn;
});
