				...
				r(e, [
					{
						...
						value: function (e, t) {
							...
							var n = (t = Ce(this.defaults, t)),
								...
								i = n.headers;
							void 0 !== r && ke.assertOptions(r, { silentJSONParsing: Ue.transitional(Ue.boolean), forcedJSONParsing: Ue.transitional(Ue.boolean), clarifyTimeoutError: Ue.transitional(Ue.boolean) }, !1), null != o && (q.isFunction(o) ? (t.paramsSerializer = { serialize: o }) : ke.assertOptions(o, { encode: Ue.function, serialize: Ue.function }, !0)), (t.method = (t.method || this.defaults.method || 'get').toLowerCase());
